			...
			<div id="slider" class="nivoSlider">
					...
					if ($imgs) {
						...
						foreach($imgs as $img) { ?>
							<a href="<?php echo $img['url'];?>">
								<img src="<?php echo $img['src'];?>" alt="" width="500" height="280" title="<?php echo CHtml::encode($img['title']);?>" />
							</a>
						<?php }
					}
				}
				...
				if(!$usePaid || count($imgs) < 3){
					if(issetModule('slider')){
						$images = Slider::model()->getActiveImages();
						$sliderImagesCount = count($images);
						if ($sliderImagesCount) {
							$this->widget('application.modules.slider.components.SliderWidget', array('images' => $images));
						}
					} else {
						?>
						<img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/slider/1.png" alt="1" width="500" height="280" />
						<img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/slider/2.jpg" alt="2" width="500" height="280" />
						<img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/slider/3.png" alt="3" width="500" height="280" />
						<img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/slider/4.jpg" alt="4" width="500" height="280" />
                                                <img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/slider/5.jpg" alt="5" width="500" height="280" />
						<?php
					}
				} ?>
			</div>
