...
<div class="form">
	...
	<?php
		echo '<div class="row"  id="row_agency_user_id">';
			...
			echo $form->dropDownList($model, 'agency_user_id', $agency, array('id' => 'agency_user_id', 'data-placeholder' => ' '));
	...
	<div class="row">
		...
		$this->widget('CustomCCaptcha', array('captchaAction' => '/site/captcha', 'buttonOptions' => array('style' => 'display:block;'))); ?><br/>
