...
class User extends ParentModel {
	...
	public function relations() {
		...
		$relation['countAdRel'] = array(self::STAT, 'Apartment', 'owner_id', 'condition' => 'active = 1 AND owner_active = 1 AND price_type IN('.implode(", ", array_keys(Apartment::getPriceArray(Apartment::PRICE_SALE, true))).')');
