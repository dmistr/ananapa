...
class SimpleformModel extends CFormModel {
	...
	public function rules() {
		return array(
			array('date_start, date_end, time_in, time_out, type, ' . (Yii::app()->user->isGuest ? 'username' : ''), 'required', 'on' => 'forrent'),
			array('type, ' . (Yii::app()->user->isGuest ? 'username' : ''), 'required', 'on' => 'forbuy'),
