...
{
$count_3364cb7e402d3bc7cf21dc1ebbb6f289 = is_array($this->functionData['reportsIndex']) ? count($this->functionData['reportsIndex']) : 0;
$this->functionData['reportsIndex'][$count_3364cb7e402d3bc7cf21dc1ebbb6f289]['reports'] = $reports;
$this->functionData['reportsIndex'][$count_3364cb7e402d3bc7cf21dc1ebbb6f289]['acts'] = $acts;
$this->functionData['reportsIndex'][$count_3364cb7e402d3bc7cf21dc1ebbb6f289]['pages'] = $pages;
$this->functionData['reportsIndex'][$count_3364cb7e402d3bc7cf21dc1ebbb6f289]['statuses'] = $statuses;
}
...
{
$count_23df897d04cc2f005d9243d718b46dae = is_array($this->functionData['viewReport']) ? count($this->functionData['viewReport']) : 0;
$this->functionData['viewReport'][$count_23df897d04cc2f005d9243d718b46dae]['options'] = $options;
$this->functionData['viewReport'][$count_23df897d04cc2f005d9243d718b46dae]['reports'] = $reports;
$this->functionData['viewReport'][$count_23df897d04cc2f005d9243d718b46dae]['comments'] = $comments;
}
$IPBHTML .= "<!--no data in this master skin-->";
return $IPBHTML;
}
