...
{
$count_ef3033a6e05ffdc9dd0981c452252764 = is_array($this->functionData['messengerDisabled']) ? count($this->functionData['messengerDisabled']) : 0;
}
...
{
$count_4c67d85a5030664331ebaffb85877e73 = is_array($this->functionData['messengerTemplate']) ? count($this->functionData['messengerTemplate']) : 0;
$this->functionData['messengerTemplate'][$count_4c67d85a5030664331ebaffb85877e73]['html'] = $html;
$this->functionData['messengerTemplate'][$count_4c67d85a5030664331ebaffb85877e73]['jumpmenu'] = $jumpmenu;
$this->functionData['messengerTemplate'][$count_4c67d85a5030664331ebaffb85877e73]['dirData'] = $dirData;
$this->functionData['messengerTemplate'][$count_4c67d85a5030664331ebaffb85877e73]['totalData'] = $totalData;
$this->functionData['messengerTemplate'][$count_4c67d85a5030664331ebaffb85877e73]['topicParticipants'] = $topicParticipants;
$this->functionData['messengerTemplate'][$count_4c67d85a5030664331ebaffb85877e73]['inlineError'] = $inlineError;
$this->functionData['messengerTemplate'][$count_4c67d85a5030664331ebaffb85877e73]['deletedTopic'] = $deletedTopic;
}
...
<div id='messenger_utilities' class='left'>
	...
	" . ((is_array( $topicParticipants ) and count( $topicParticipants )) ? ("<div class='ipsSideBlock' id='participants'>
			...
			<ul id='participants_list' class='ipsList_withminiphoto fullList'>
				".$this->__f__83944bfb35298f395945904dc5ad3054($html,$jumpmenu,$dirData,$totalData,$topicParticipants,$inlineError,$deletedTopic)."					
			</ul>
	...
	<div id='folder_list' class='ipsSideBlock'>
		...
		<ol id='folders'>
			" . ((count($dirData)) ? ("
				".$this->__f__f5cabaf510809217a450c2d3f729d819($html,$jumpmenu,$dirData,$totalData,$topicParticipants,$inlineError,$deletedTopic)."			") : ("")) . "
		</ol>
...
function __f__83944bfb35298f395945904dc5ad3054($html, $jumpmenu, $dirData, $totalData=array(), $topicParticipants=array(), $inlineError='', $deletedTopic=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__f5cabaf510809217a450c2d3f729d819($html, $jumpmenu, $dirData, $totalData=array(), $topicParticipants=array(), $inlineError='', $deletedTopic=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_8f8fa8617f7faab0fc526ff459d2441d = is_array($this->functionData['sendNewPersonalTopicForm']) ? count($this->functionData['sendNewPersonalTopicForm']) : 0;
$this->functionData['sendNewPersonalTopicForm'][$count_8f8fa8617f7faab0fc526ff459d2441d]['displayData'] = $displayData;
}
...
<div class='message error'>
	...
	".$this->__f__1bd867e8057c25d32e487250dc0e3f6b($displayData)."	<p>{$this->lang->words['pme_none_sent']}</p>
</div>
</div>
") : ("")) . "
...
function __f__1bd867e8057c25d32e487250dc0e3f6b($displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_978f9c6937fb65d4a34e69d4bfb66d84 = is_array($this->functionData['sendReplyForm']) ? count($this->functionData['sendReplyForm']) : 0;
$this->functionData['sendReplyForm'][$count_978f9c6937fb65d4a34e69d4bfb66d84]['displayData'] = $displayData;
}
$IPBHTML .= "<div id='message_compose' class='post_form'>
...
<div class='message error'>
    <h4>{$this->lang->words['err_errors']}</h4>
    ".$this->__f__aab34827b9c3cf4dac31ab31e7b12344($displayData)."    <p>{$this->lang->words['pme_none_sent']}</p>
</div><br />
") : ("")) . "
...
function __f__aab34827b9c3cf4dac31ab31e7b12344($displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $displayData['errors'] as $_error )
...
{
$count_a7bab8c72a27f82c9eba703f2d00e637 = is_array($this->functionData['showConversation']) ? count($this->functionData['showConversation']) : 0;
$this->functionData['showConversation'][$count_a7bab8c72a27f82c9eba703f2d00e637]['topic'] = $topic;
$this->functionData['showConversation'][$count_a7bab8c72a27f82c9eba703f2d00e637]['replies'] = $replies;
$this->functionData['showConversation'][$count_a7bab8c72a27f82c9eba703f2d00e637]['members'] = $members;
$this->functionData['showConversation'][$count_a7bab8c72a27f82c9eba703f2d00e637]['jump'] = $jump;
}
...
<div class='ipsBox removeDefault'>
	<div class='ipsBox_container'>
		".$this->__f__cae7443e9d9fb9a5b3d1d7b5065c5f3a($topic,$replies,$members,$jump)."	</div>
</div>" . $this->registry->getClass('output')->getReplacement("box_end") . "
...
function __f__cae7443e9d9fb9a5b3d1d7b5065c5f3a($topic, $replies, $members, $jump="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_35455cb4e04fc3fe45ba56e2234789f6 = is_array($this->functionData['showConversationForArchive']) ? count($this->functionData['showConversationForArchive']) : 0;
$this->functionData['showConversationForArchive'][$count_35455cb4e04fc3fe45ba56e2234789f6]['topic'] = $topic;
$this->functionData['showConversationForArchive'][$count_35455cb4e04fc3fe45ba56e2234789f6]['replies'] = $replies;
$this->functionData['showConversationForArchive'][$count_35455cb4e04fc3fe45ba56e2234789f6]['members'] = $members;
}
...
$IPBHTML .= "<html>
	...
	<body>
		...
		<br />
		<br />
		".$this->__f__106b6f8cb9cb7dd03f01d3ef3fc29904($topic,$replies,$members)."	</body>
</html>";
return $IPBHTML;
}


function __f__106b6f8cb9cb7dd03f01d3ef3fc29904($topic, $replies, $members)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $replies as $msg_id => $msg )
...
{
$count_d60bee2e708bd7ee71e4bfd8fc2c82bf = is_array($this->functionData['showFolder']) ? count($this->functionData['showFolder']) : 0;
$this->functionData['showFolder'][$count_d60bee2e708bd7ee71e4bfd8fc2c82bf]['messages'] = $messages;
$this->functionData['showFolder'][$count_d60bee2e708bd7ee71e4bfd8fc2c82bf]['dirname'] = $dirname;
$this->functionData['showFolder'][$count_d60bee2e708bd7ee71e4bfd8fc2c82bf]['pages'] = $pages;
$this->functionData['showFolder'][$count_d60bee2e708bd7ee71e4bfd8fc2c82bf]['currentFolderID'] = $currentFolderID;
$this->functionData['showFolder'][$count_d60bee2e708bd7ee71e4bfd8fc2c82bf]['jumpFolderHTML'] = $jumpFolderHTML;
}
		...
		<div class='ipsBox removeDefault'>
			<div class='ipsBox_container'>
				<table class='ipb_table' id='message_table'>
					...
					" . ((count( $messages )) ? ("
						".$this->__f__70170554e1ba83845d195327dad24543($messages,$dirname,$pages,$currentFolderID,$jumpFolderHTML)."					") : ("
						<tr>
...
function __f__13e8c3ca4a0270bd3cee58fad1ae1e60($messages, $dirname, $pages, $currentFolderID, $jumpFolderHTML,$id='',$msg='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__70170554e1ba83845d195327dad24543($messages, $dirname, $pages, $currentFolderID, $jumpFolderHTML)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
							...
							<tr id='{$msg['mt_id']}' class='" . (($msg['map_has_unread']) ? ("unread") : ("")) . "'>
								...
								<td class='col_m_subject'>
									...
									" . ((is_array( $msg['pages'] ) AND count( $msg['pages'] )) ? ("
										...
										".$this->__f__13e8c3ca4a0270bd3cee58fad1ae1e60($messages,$dirname,$pages,$currentFolderID,$jumpFolderHTML,$id,$msg)."										</ul>
									") : ("")) . "
								</td>
...
{
$count_07524b6aca47a3e6f811782dd088e30f = is_array($this->functionData['showSearchResults']) ? count($this->functionData['showSearchResults']) : 0;
$this->functionData['showSearchResults'][$count_07524b6aca47a3e6f811782dd088e30f]['messages'] = $messages;
$this->functionData['showSearchResults'][$count_07524b6aca47a3e6f811782dd088e30f]['pages'] = $pages;
$this->functionData['showSearchResults'][$count_07524b6aca47a3e6f811782dd088e30f]['error'] = $error;
}
$IPBHTML .= "<script type='text/javascript'>
//<![CDATA[
	...
	<div class='ipsBox removeDefault'>
		<div class='ipsBox_container'>
			<table class='ipb_table' id='message_table'>
				...
				" . ((count( $messages )) ? ("
					".$this->__f__26e64a98a28a537ac8eeeab1b94c6b77($messages,$pages,$error)."				") : ("
					<tr>
...
function __f__26e64a98a28a537ac8eeeab1b94c6b77($messages, $pages, $error)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $messages as $id => $msg )
