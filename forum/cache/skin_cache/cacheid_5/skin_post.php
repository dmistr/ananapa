...
{
$count_5dba314715157826441ab8ff24289b97 = is_array($this->functionData['pollBox']) ? count($this->functionData['pollBox']) : 0;
$this->functionData['pollBox'][$count_5dba314715157826441ab8ff24289b97]['data'] = $data;
}
...
{
$count_bd0b88e7cf73bac076cb19e911dc7241 = is_array($this->functionData['postFormTemplate']) ? count($this->functionData['postFormTemplate']) : 0;
$this->functionData['postFormTemplate'][$count_bd0b88e7cf73bac076cb19e911dc7241]['formData'] = $formData;
$this->functionData['postFormTemplate'][$count_bd0b88e7cf73bac076cb19e911dc7241]['form'] = $form;
}
...
{
$count_6b5b9e1b7cb44e3d493f4a66569b5c51 = is_array($this->functionData['preview']) ? count($this->functionData['preview']) : 0;
$this->functionData['preview'][$count_6b5b9e1b7cb44e3d493f4a66569b5c51]['data'] = $data;
}
...
{
$count_e034c8ad1d7629a1b59acf719461fee7 = is_array($this->functionData['topicSummary']) ? count($this->functionData['topicSummary']) : 0;
$this->functionData['topicSummary'][$count_e034c8ad1d7629a1b59acf719461fee7]['posts'] = $posts;
}
...
" . ((is_array( $posts ) AND count( $posts )) ? ("
	".$this->__f__6aa956df02e09adbf470e432fc9da032($posts)."") : ("")) . "
<p class='submit'>
...
function __f__6aa956df02e09adbf470e432fc9da032($posts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_fee2551b9d6d129ea918f600cac254a0 = is_array($this->functionData['uploadForm']) ? count($this->functionData['uploadForm']) : 0;
$this->functionData['uploadForm'][$count_fee2551b9d6d129ea918f600cac254a0]['post_key'] = $post_key;
$this->functionData['uploadForm'][$count_fee2551b9d6d129ea918f600cac254a0]['type'] = $type;
$this->functionData['uploadForm'][$count_fee2551b9d6d129ea918f600cac254a0]['stats'] = $stats;
$this->functionData['uploadForm'][$count_fee2551b9d6d129ea918f600cac254a0]['id'] = $id;
$this->functionData['uploadForm'][$count_fee2551b9d6d129ea918f600cac254a0]['forum_id'] = $forum_id;
}
