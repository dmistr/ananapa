...
{
$count_fc0cf9ac877b5a8cc8f4e2954fe7b19e = is_array($this->functionData['deletedPosts']) ? count($this->functionData['deletedPosts']) : 0;
$this->functionData['deletedPosts'][$count_fc0cf9ac877b5a8cc8f4e2954fe7b19e]['posts'] = $posts;
$this->functionData['deletedPosts'][$count_fc0cf9ac877b5a8cc8f4e2954fe7b19e]['other_data'] = $other_data;
$this->functionData['deletedPosts'][$count_fc0cf9ac877b5a8cc8f4e2954fe7b19e]['pagelinks'] = $pagelinks;
}
...
<div class='clearfix'>
	" . ((is_array( $posts ) AND count( $posts )) ? ("
		<div id='ips_Posts'>
			".$this->__f__85e0a253b76727120380fef798997efa($posts,$other_data,$pagelinks)."		</div>
	") : ("
...
function __f__85e0a253b76727120380fef798997efa($posts, $other_data=array(), $pagelinks='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_04a78ff5b71a31ef1d92419c9a040f47 = is_array($this->functionData['deletedTopics']) ? count($this->functionData['deletedTopics']) : 0;
$this->functionData['deletedTopics'][$count_04a78ff5b71a31ef1d92419c9a040f47]['topics'] = $topics;
$this->functionData['deletedTopics'][$count_04a78ff5b71a31ef1d92419c9a040f47]['sdelete'] = $sdelete;
$this->functionData['deletedTopics'][$count_04a78ff5b71a31ef1d92419c9a040f47]['pagelinks'] = $pagelinks;
}
...
{
$count_ec7a264611d63d1eae4bd80f767aa4be = is_array($this->functionData['editUserForm']) ? count($this->functionData['editUserForm']) : 0;
$this->functionData['editUserForm'][$count_ec7a264611d63d1eae4bd80f767aa4be]['profile'] = $profile;
$this->functionData['editUserForm'][$count_ec7a264611d63d1eae4bd80f767aa4be]['custom_fields'] = $custom_fields;
}
	...
	<fieldset>
		...
		" . ((count($custom_fields->out_fields)) ? ("
			...
			<ul class='ipsForm ipsForm_horizontal'>
				...
				".$this->__f__f14fdb1f250ae1e86adf0a40bab1341c($profile,$custom_fields)."			</ul>
		") : ("")) . "
...
function __f__f14fdb1f250ae1e86adf0a40bab1341c($profile, $custom_fields=null)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_f5254c98ae06b97cc3abf78830167695 = is_array($this->functionData['latestWarnLogs']) ? count($this->functionData['latestWarnLogs']) : 0;
$this->functionData['latestWarnLogs'][$count_f5254c98ae06b97cc3abf78830167695]['warnings'] = $warnings;
$this->functionData['latestWarnLogs'][$count_f5254c98ae06b97cc3abf78830167695]['pagelinks'] = $pagelinks;
}
...
<div class='clearfix'>
	<table class='ipb_table'>
		...
		" . ((is_array( $warnings ) AND count( $warnings )) ? ("
						".$this->__f__a7ec5c2b61f6c83ae117cfda98ce7f4b($warnings,$pagelinks)."		") : ("
			<tr>
...
function __f__a7ec5c2b61f6c83ae117cfda98ce7f4b($warnings, $pagelinks)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_d14cca9ea3d241e0f3474597bbcc1651 = is_array($this->functionData['memberLookup']) ? count($this->functionData['memberLookup']) : 0;
}
...
{
$count_da7b19643edaf577ca6a9e59b66d1dab = is_array($this->functionData['membersList']) ? count($this->functionData['membersList']) : 0;
$this->functionData['membersList'][$count_da7b19643edaf577ca6a9e59b66d1dab]['type'] = $type;
$this->functionData['membersList'][$count_da7b19643edaf577ca6a9e59b66d1dab]['members'] = $members;
$this->functionData['membersList'][$count_da7b19643edaf577ca6a9e59b66d1dab]['pagelinks'] = $pagelinks;
}
		...
		<div id='member_wrap'>
			<ul class='ipsMemberList'>
				" . ((is_array( $members ) and count( $members )) ? ("
										".$this->__f__c6b32b608623490491625fdd42fddda6($type,$members,$pagelinks)."				") : ("
...
function __f__c6b32b608623490491625fdd42fddda6($type, $members, $pagelinks='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_e8534986b5964691e4dac8b559885c8f = is_array($this->functionData['membersModIPForm']) ? count($this->functionData['membersModIPForm']) : 0;
$this->functionData['membersModIPForm'][$count_e8534986b5964691e4dac8b559885c8f]['ip'] = $ip;
$this->functionData['membersModIPForm'][$count_e8534986b5964691e4dac8b559885c8f]['inlineMsg'] = $inlineMsg;
}
...
{
$count_2e30b40c9043192eadd15d6a098de9e0 = is_array($this->functionData['membersModIPFormMembers']) ? count($this->functionData['membersModIPFormMembers']) : 0;
$this->functionData['membersModIPFormMembers'][$count_2e30b40c9043192eadd15d6a098de9e0]['pages'] = $pages;
$this->functionData['membersModIPFormMembers'][$count_2e30b40c9043192eadd15d6a098de9e0]['members'] = $members;
}
...
<table class='ipb_table'>
	...
	" . ((is_array( $members ) AND count( $members )) ? ("
				".$this->__f__c55c1a509826fd28abdfb0481d2ab04f($pages,$members)."	") : ("")) . "
</table>
<br />
...
function __f__c55c1a509826fd28abdfb0481d2ab04f($pages="",$members)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_e227bd97a990994a2214d38ec830744b = is_array($this->functionData['membersModIPFormPosts']) ? count($this->functionData['membersModIPFormPosts']) : 0;
$this->functionData['membersModIPFormPosts'][$count_e227bd97a990994a2214d38ec830744b]['count'] = $count;
$this->functionData['membersModIPFormPosts'][$count_e227bd97a990994a2214d38ec830744b]['pageLinks'] = $pageLinks;
$this->functionData['membersModIPFormPosts'][$count_e227bd97a990994a2214d38ec830744b]['results'] = $results;
}
...
<br />
" . ((count($results)) ? ("
		".$this->__f__1694d49a63b7f10f52f71da8452a90c0($count,$pageLinks,$results)."") : ("")) . "
<br />
<div class='topic_controls'>
	{$pageLinks}
</div>";
...
function __f__1694d49a63b7f10f52f71da8452a90c0($count=0, $pageLinks='', $results)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_2f95e3af5d946bbbdb66c6d6e16b4110 = is_array($this->functionData['modAnnounceForm']) ? count($this->functionData['modAnnounceForm']) : 0;
$this->functionData['modAnnounceForm'][$count_2f95e3af5d946bbbdb66c6d6e16b4110]['announce'] = $announce;
$this->functionData['modAnnounceForm'][$count_2f95e3af5d946bbbdb66c6d6e16b4110]['forum_html'] = $forum_html;
$this->functionData['modAnnounceForm'][$count_2f95e3af5d946bbbdb66c6d6e16b4110]['type'] = $type;
$this->functionData['modAnnounceForm'][$count_2f95e3af5d946bbbdb66c6d6e16b4110]['editor_html'] = $editor_html;
$this->functionData['modAnnounceForm'][$count_2f95e3af5d946bbbdb66c6d6e16b4110]['msg'] = $msg;
}
...
{
$count_3d3bc023650182103fddc24b23ece127 = is_array($this->functionData['modAnnouncements']) ? count($this->functionData['modAnnouncements']) : 0;
$this->functionData['modAnnouncements'][$count_3d3bc023650182103fddc24b23ece127]['announcements'] = $announcements;
}
...
<div class='topic_buttons'>
	...
	<table class='ipb_table' summary=\"{$this->lang->words['ucp_announcements']}\">
		...
		" . ((is_array( $announcements ) AND count( $announcements )) ? ("
						".$this->__f__839f0d3ae12454daf78f8c057b5ec279($announcements)."		") : ("
			<tr>
...
function __f__f194b59cb20a94da688119ff06295f75($announcements,$announce='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__839f0d3ae12454daf78f8c057b5ec279($announcements)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
					...
					<td>
						<div class=\"forumdesc\">
							...
							") : ("" . ((is_array( $announce['_forums'] ) and count( $announce['_forums'] )) ? ("
									<ul>
									".$this->__f__f194b59cb20a94da688119ff06295f75($announcements,$announce)."									</ul>
								") : ("
...
{
$count_b403ba840a4f407c410f1be06cf89ca3 = is_array($this->functionData['modControls']) ? count($this->functionData['modControls']) : 0;
$this->functionData['modControls'][$count_b403ba840a4f407c410f1be06cf89ca3]['editmember'] = $editmember;
$this->functionData['modControls'][$count_b403ba840a4f407c410f1be06cf89ca3]['warnpanel'] = $warnpanel;
$this->functionData['modControls'][$count_b403ba840a4f407c410f1be06cf89ca3]['warnlogs'] = $warnlogs;
$this->functionData['modControls'][$count_b403ba840a4f407c410f1be06cf89ca3]['noteForm'] = $noteForm;
$this->functionData['modControls'][$count_b403ba840a4f407c410f1be06cf89ca3]['return'] = $return;
}
...
{
$count_2037c51d5caa09a65dd4968e04017ff5 = is_array($this->functionData['modcpMessage']) ? count($this->functionData['modcpMessage']) : 0;
$this->functionData['modcpMessage'][$count_2037c51d5caa09a65dd4968e04017ff5]['message'] = $message;
}
...
{
$count_3be26a09354613be50486317571eb9bd = is_array($this->functionData['modCPpost']) ? count($this->functionData['modCPpost']) : 0;
$this->functionData['modCPpost'][$count_3be26a09354613be50486317571eb9bd]['post'] = $post;
$this->functionData['modCPpost'][$count_3be26a09354613be50486317571eb9bd]['displayData'] = $displayData;
$this->functionData['modCPpost'][$count_3be26a09354613be50486317571eb9bd]['topic'] = $topic;
$this->functionData['modCPpost'][$count_3be26a09354613be50486317571eb9bd]['type'] = $type;
}
...
{
$count_293e64fc2c5932a8b5e6ed5e93ef10d9 = is_array($this->functionData['modCPtopic']) ? count($this->functionData['modCPtopic']) : 0;
$this->functionData['modCPtopic'][$count_293e64fc2c5932a8b5e6ed5e93ef10d9]['topics'] = $topics;
$this->functionData['modCPtopic'][$count_293e64fc2c5932a8b5e6ed5e93ef10d9]['pagelinks'] = $pagelinks;
$this->functionData['modCPtopic'][$count_293e64fc2c5932a8b5e6ed5e93ef10d9]['type'] = $type;
$this->functionData['modCPtopic'][$count_293e64fc2c5932a8b5e6ed5e93ef10d9]['sdelete'] = $sdelete;
}
$IPBHTML .= "".$this->__f__60d7cdd69c9699a80fe75f3a6237bca2($topics,$pagelinks,$type,$sdelete)."";
return $IPBHTML;
}


function __f__baf631914e8e8451a91362b47d9a40de($topics, $pagelinks, $type, $sdelete=array(),$tid='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__60d7cdd69c9699a80fe75f3a6237bca2($topics, $pagelinks, $type, $sdelete=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	...
	<tr class='__topic' id='trow_{$data['tid']}' data-tid=\"{$data['tid']}\">
		<td class='__tid{$data['tid']} with_mod_links'>	
			...
			" . ((isset( $data['pages'] ) AND is_array( $data['pages'] ) AND count( $data['pages'] )) ? ("
				...
				".$this->__f__baf631914e8e8451a91362b47d9a40de($topics,$pagelinks,$type,$sdelete,$tid,$data)."				</ul>
			") : ("")) . "
			<br />
...
{
$count_319ef369a2bcf31729d36ec2afbdf0fe = is_array($this->functionData['overview']) ? count($this->functionData['overview']) : 0;
}
$IPBHTML .= "<div class='clearfix '>
	<div class='ipsBox_container ipsPad'>
		<p>{$this->lang->words['intro_blurb']}</p>
...
{
$count_949bf29d55cb8027970a0f9d89821475 = is_array($this->functionData['portalPage']) ? count($this->functionData['portalPage']) : 0;
$this->functionData['portalPage'][$count_949bf29d55cb8027970a0f9d89821475]['output'] = $output;
$this->functionData['portalPage'][$count_949bf29d55cb8027970a0f9d89821475]['tabs'] = $tabs;
$this->functionData['portalPage'][$count_949bf29d55cb8027970a0f9d89821475]['_activeNav'] = $_activeNav;
}
	...
	<div class='ipsVerticalTabbed ipsLayout ipsLayout_withleft ipsLayout_smallleft clearfix'>
		<div class='ipsVerticalTabbed_tabs ipsLayout_left' id='modcp_tabs'>
			<ul class='clear'>
				...
				".$this->__f__8237e42b3a1a2f1a89c81b1e326316ae($output,$tabs,$_activeNav)."			</ul>
		</div>
...
function __f__8237e42b3a1a2f1a89c81b1e326316ae($output, $tabs=array(), $_activeNav=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_46b9066b8e6a03a58537918b15edf809 = is_array($this->functionData['subTabLoop']) ? count($this->functionData['subTabLoop']) : 0;
}
$IPBHTML .= "".$this->__f__a267b2b778b6b09e3d0ed75a76d70749()."";
return $IPBHTML;
}


function __f__9f2752fb3b12fa01a1fdc72771bbeb04($mainTabKey='',$subTabs='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__a267b2b778b6b09e3d0ed75a76d70749()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	...
	" . (($mainTabKey == $this->templateVars['activeNav']['primary']) ? ("" . ((count( $subTabs ) > 1) ? ("
			<div class='maintitle ipsFilterbar clear'>
				<ul class='ipsList_inline'>									
					".$this->__f__9f2752fb3b12fa01a1fdc72771bbeb04($mainTabKey,$subTabs)."				</ul>
			</div>
		") : ("")) . "") : ("")) . "
...
{
$count_f57607152bff3ce13eae186ccfc5b453 = is_array($this->functionData['unapprovedPosts']) ? count($this->functionData['unapprovedPosts']) : 0;
$this->functionData['unapprovedPosts'][$count_f57607152bff3ce13eae186ccfc5b453]['posts'] = $posts;
$this->functionData['unapprovedPosts'][$count_f57607152bff3ce13eae186ccfc5b453]['pagelinks'] = $pagelinks;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("topic", "0" ) . "
" . ((!$this->settings['disable_lightbox']) ? ("
" . ( method_exists( $this->registry->getClass('output')->getTemplate('global'), 'include_lightbox' ) ? $this->registry->getClass('output')->getTemplate('global')->include_lightbox() : '' ) . "
...
<div class='clearfix'>
	" . ((is_array( $posts ) AND count( $posts )) ? ("
		<div id='ips_Posts2'>
			".$this->__f__7d212485eaae0ad91031e0cff8151836($posts,$pagelinks)."		</div>
	") : ("
		<div class='no_messages'>
...
function __f__7d212485eaae0ad91031e0cff8151836($posts, $pagelinks)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $posts as $post )
...
{
$count_9dd7d7958e247c386a4204923c9cf0b7 = is_array($this->functionData['unapprovedTopics']) ? count($this->functionData['unapprovedTopics']) : 0;
$this->functionData['unapprovedTopics'][$count_9dd7d7958e247c386a4204923c9cf0b7]['topics'] = $topics;
$this->functionData['unapprovedTopics'][$count_9dd7d7958e247c386a4204923c9cf0b7]['pagelinks'] = $pagelinks;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("forums", "0" ) . "
<div>{$pagelinks}</div>
" . ( method_exists( $this->registry->getClass('output')->getTemplate('modcp'), 'subTabLoop' ) ? $this->registry->getClass('output')->getTemplate('modcp')->subTabLoop() : '' ) . "
...
{
$count_0b33c5a00b7fad7f973d6dbdf3b8404c = is_array($this->functionData['warn_view_log']) ? count($this->functionData['warn_view_log']) : 0;
$this->functionData['warn_view_log'][$count_0b33c5a00b7fad7f973d6dbdf3b8404c]['member'] = $member;
$this->functionData['warn_view_log'][$count_0b33c5a00b7fad7f973d6dbdf3b8404c]['rows'] = $rows;
$this->functionData['warn_view_log'][$count_0b33c5a00b7fad7f973d6dbdf3b8404c]['links'] = $links;
}
...
$IPBHTML .= "" . (($this->request['module']=='ajax') ? ("
	...
	") : ("")) . "
		<table class='ipb_table'>
			...
			") : ("
								".$this->__f__bc843ece0da202965de440c14e6132e4($member,$rows,$links)."			")) . "
		</table>
...
function __f__bc843ece0da202965de440c14e6132e4($member, $rows, $links='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $r )
...
{
$count_8c9922fe7654651e0a48d1a4c5d85fe9 = is_array($this->functionData['warnForm']) ? count($this->functionData['warnForm']) : 0;
$this->functionData['warnForm'][$count_8c9922fe7654651e0a48d1a4c5d85fe9]['member'] = $member;
$this->functionData['warnForm'][$count_8c9922fe7654651e0a48d1a4c5d85fe9]['errors'] = $errors;
$this->functionData['warnForm'][$count_8c9922fe7654651e0a48d1a4c5d85fe9]['modque'] = $modque;
$this->functionData['warnForm'][$count_8c9922fe7654651e0a48d1a4c5d85fe9]['postque'] = $postque;
$this->functionData['warnForm'][$count_8c9922fe7654651e0a48d1a4c5d85fe9]['ban'] = $ban;
$this->functionData['warnForm'][$count_8c9922fe7654651e0a48d1a4c5d85fe9]['editor_html'] = $editor_html;
}
