...
{
$count_18ee1bce41d6dfe1a333f66fccecd5a5 = is_array($this->functionData['ajax__inlineLogInForm']) ? count($this->functionData['ajax__inlineLogInForm']) : 0;
}
...
{
$count_032d9e0dacde0f34029d8ed405d66e8f = is_array($this->functionData['showLogInForm']) ? count($this->functionData['showLogInForm']) : 0;
$this->functionData['showLogInForm'][$count_032d9e0dacde0f34029d8ed405d66e8f]['message'] = $message;
$this->functionData['showLogInForm'][$count_032d9e0dacde0f34029d8ed405d66e8f]['referer'] = $referer;
$this->functionData['showLogInForm'][$count_032d9e0dacde0f34029d8ed405d66e8f]['extra_form'] = $extra_form;
$this->functionData['showLogInForm'][$count_032d9e0dacde0f34029d8ed405d66e8f]['login_methods'] = $login_methods;
$this->functionData['showLogInForm'][$count_032d9e0dacde0f34029d8ed405d66e8f]['facebookOpts'] = $facebookOpts;
}
				...
				<div class='right ipsPad_double' id='other_signin'>
					<ul class='ipsList_data clear ipsType_small'>
						...
						" . ((is_array($extra_form) AND count($extra_form)) ? ("
							".$this->__f__c4da93f2ee6eaddb50c8675c02c4463e($message,$referer,$extra_form,$login_methods,$facebookOpts)."						") : ("")) . "
					</ul>
				</div>
			</div>
			" . ((IPSLib::loginMethod_enabled('live')) ? ("
...
function __f__c4da93f2ee6eaddb50c8675c02c4463e($message="",$referer="",$extra_form="", $login_methods=array(), $facebookOpts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
