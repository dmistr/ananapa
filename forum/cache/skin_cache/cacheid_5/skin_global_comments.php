...
{
$count_3c8f061dc2b312a8f2fcc071f8bf7ff7 = is_array($this->functionData['comment']) ? count($this->functionData['comment']) : 0;
$this->functionData['comment'][$count_3c8f061dc2b312a8f2fcc071f8bf7ff7]['r'] = $r;
$this->functionData['comment'][$count_3c8f061dc2b312a8f2fcc071f8bf7ff7]['parent'] = $parent;
$this->functionData['comment'][$count_3c8f061dc2b312a8f2fcc071f8bf7ff7]['settings'] = $settings;
}
...
{
$count_71d0a87b874940a09daa86fc49a5d63a = is_array($this->functionData['commentHidden']) ? count($this->functionData['commentHidden']) : 0;
$this->functionData['commentHidden'][$count_71d0a87b874940a09daa86fc49a5d63a]['r'] = $r;
$this->functionData['commentHidden'][$count_71d0a87b874940a09daa86fc49a5d63a]['parent'] = $parent;
$this->functionData['commentHidden'][$count_71d0a87b874940a09daa86fc49a5d63a]['settings'] = $settings;
}
...
{
$count_bf3b4db099c00cbe12a956585de5c3d1 = is_array($this->functionData['commentsList']) ? count($this->functionData['commentsList']) : 0;
$this->functionData['commentsList'][$count_bf3b4db099c00cbe12a956585de5c3d1]['comments'] = $comments;
$this->functionData['commentsList'][$count_bf3b4db099c00cbe12a956585de5c3d1]['settings'] = $settings;
$this->functionData['commentsList'][$count_bf3b4db099c00cbe12a956585de5c3d1]['pages'] = $pages;
$this->functionData['commentsList'][$count_bf3b4db099c00cbe12a956585de5c3d1]['parent'] = $parent;
$this->functionData['commentsList'][$count_bf3b4db099c00cbe12a956585de5c3d1]['preReply'] = $preReply;
}
...
<div class='ipsComment_wrap' id='comment_wrap'>
	".$this->__f__c32a10340f0f61c6f53c5a5945ce3e89($comments,$settings,$pages,$parent,$preReply)."</div>
...
function __f__c32a10340f0f61c6f53c5a5945ce3e89($comments, $settings, $pages, $parent, $preReply='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_04359dd38cd4cffd62da1341ba116688 = is_array($this->functionData['form']) ? count($this->functionData['form']) : 0;
$this->functionData['form'][$count_04359dd38cd4cffd62da1341ba116688]['comment'] = $comment;
$this->functionData['form'][$count_04359dd38cd4cffd62da1341ba116688]['parent'] = $parent;
$this->functionData['form'][$count_04359dd38cd4cffd62da1341ba116688]['editor'] = $editor;
$this->functionData['form'][$count_04359dd38cd4cffd62da1341ba116688]['settings'] = $settings;
$this->functionData['form'][$count_04359dd38cd4cffd62da1341ba116688]['errors'] = $errors;
$this->functionData['form'][$count_04359dd38cd4cffd62da1341ba116688]['do'] = $do;
}
$IPBHTML .= "" . (($errors) ? ("
