...
/* CACHE FILE: Generated: Fri, 22 Jan 2016 20:12:36 GMT */
...
$this->_funcHooks['globalTemplate'] = array('showingapp','applications','navigationlink','closenavigationlink','forsuredidfirstnav','navigation','didfirstappnowbottom','navigationlink','closenavigationlink','forsuredidfirstnavbottom','navigationbottom','isCoreRC','hideRcForPerms','fbcenabled','isLargeTouch','isSmallTouch','brandingBar','showhomeurl','applicationsloop','hasCustomPrimaryNavigation','notifications','messengerlink','notifications','showInboxNotify','ipsconnectRevalidateUrl','authenticating','updateTwitter','updateFacebook','update','canUpdateStatus','userLikeLink','nobbyNoMates','bloglink','pmLink','gallerylink','nexuslink','limFacebook','limTwitter','limWindows','memberbox','showacplink','rclink','accessreports','canSearch','didfirstnav','switchnavigation','ruleslink','siterulestitle','siteruleslink','viewnewcontentapp','showQuickNav','hasHeaderAd','mainpageContent','hasFooterAd','didfirstnavbottom','switchnavigationbottom','countnavbottom','isTouchDevice','skinchangerInner','uagentlocked','skinchangerOuter','langchooser','markRead','privvy','lastvisit','isfloat','sqldebuglink','closesqldebuglink','showdebuglevel','includeLightboxDoReal','vigLinkEnabled');
...
$this->_funcHooks['quickSearch'] = array('inThisAppSearch','inThisAppNotSearch','appLoop','inTopic','inForum','appContextSearch','lookElsewhere','inThisAppForums','inThisAppMembers','inThisAppCore','hasSearchApp');
...
$IPBHTML = "";
$IPBHTML .= "" . (($this->settings['textLogo']=='yes') ? ("
<a href='{$this->settings['board_url']}' class='textLogo' title='{$this->lang->words['go_home']}' rel=\"home\" accesskey='1'>Форум Анапы</a>
") : ("
...
{
$count_357e3fb598aa27c00949b6c7071820bf = is_array($this->functionData['globalTemplate']) ? count($this->functionData['globalTemplate']) : 0;
$this->functionData['globalTemplate'][$count_357e3fb598aa27c00949b6c7071820bf]['html'] = $html;
$this->functionData['globalTemplate'][$count_357e3fb598aa27c00949b6c7071820bf]['documentHeadItems'] = $documentHeadItems;
$this->functionData['globalTemplate'][$count_357e3fb598aa27c00949b6c7071820bf]['css'] = $css;
$this->functionData['globalTemplate'][$count_357e3fb598aa27c00949b6c7071820bf]['jsModules'] = $jsModules;
$this->functionData['globalTemplate'][$count_357e3fb598aa27c00949b6c7071820bf]['metaTags'] = $metaTags;
$this->functionData['globalTemplate'][$count_357e3fb598aa27c00949b6c7071820bf]['header_items'] = $header_items;
$this->functionData['globalTemplate'][$count_357e3fb598aa27c00949b6c7071820bf]['items'] = $items;
$this->functionData['globalTemplate'][$count_357e3fb598aa27c00949b6c7071820bf]['footer_items'] = $footer_items;
$this->functionData['globalTemplate'][$count_357e3fb598aa27c00949b6c7071820bf]['stats'] = $stats;
}
...
$IPBHTML .= "<!DOCTYPE html>
	...
	<head>
		...
		" . (($this->settings['customBackground']=='yes') ? ("<script type=\"text/javascript\">
		jQuery.noConflict();
		...
		jQuery(document).ready(function($){
			...
			if ( ($.cookie('twentyBackgroundImage') != null))	{
				$(\"style#styleBackground\").replaceWith('<style id=\"styleBackground\" type=\"text/css\">' + customBackground + '{ background-color: ' + $.cookie('twentyBackgroundHex') + '; background-image: url({style_images_url}/backgrounds/' + $.cookie('twentyBackgroundImage') + '.jpg); }' + blurElements + '{ background-color: ' + $.cookie('twentyBlurBackgroundHex') + '; background-image: url({style_images_url}/backgrounds/' + $.cookie('twentyBackgroundImage') + '_blur.jpg); }</style>');
			}
			else{
				$(\"style#styleBackground\").replaceWith('<style id=\"styleBackground\" type=\"text/css\">' + customBackground + '{ background-color: #000; background-image: url({style_images_url}/backgrounds/background1.jpg); }' + blurElements + '{ background-color: #a9a4a2; background-image: url({style_images_url}/backgrounds/background1_blur.jpg); }</style>');
			}
		
		});
		</script>
		<style type='text/css' id='styleBackground'></style>") : ("")) . "" . ( method_exists( $this->registry->getClass('output')->getTemplate('global'), 'includeJS' ) ? $this->registry->getClass('output')->getTemplate('global')->includeJS($jsModules) : '' ) . "" . ( method_exists( $this->registry->getClass('output')->getTemplate('global'), 'includeFeeds' ) ? $this->registry->getClass('output')->getTemplate('global')->includeFeeds($documentHeadItems) : '' ) . "" . ( method_exists( $this->registry->getClass('output')->getTemplate('global'), 'includeRTL' ) ? $this->registry->getClass('output')->getTemplate('global')->includeRTL() : '' ) . "		
	...
	<body " . (($this->settings['customBackground']=='yes') ? ("class='cbe'") : ("")) . " id='ipboard_body'>
...
" . (($this->settings['customBackground']=='yes') ? ("<span id='nav_background'><img src='{style_images_url}/backgroundChanger.png' alt='' /></span>") : ("")) . "
		                		<!-- ::: APPLICATION TABS ::: -->
				<div id='primary_nav' class='clearfix'>
	                <ul class='ipsList_inline' id='community_app_menu'>
	                    ...
	                    " . ((!empty($header_items['primary_navigation_menu'])) ? ("
	                        ...
	                        ".$this->__f__43d53cf4170eb33a2b0e7d4a88c8b726($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."	                    ") : ("")) . "")) . "
                ...
                " . (($this->settings['customBackground']=='yes') ? ("<div id='toggle_background'><div id='custom_background' class='clearfix'><div>
                    <span data-backgroundImage='background1' data-backgroundColor=\"#211d1b\" data-blurBackgroundColor=\"#908e8d\" style='background-image: url({style_images_url}/backgrounds/background1.jpg);'></span>
                    <span data-backgroundImage='background2' data-backgroundColor=\"#c6cdd6\" data-blurBackgroundColor=\"#e3e6eb\" style='background-image: url({style_images_url}/backgrounds/background2.jpg);'></span>
                    <span data-backgroundImage='background3' data-backgroundColor=\"#e5dccb\" data-blurBackgroundColor=\"#f2eee5\" style='background-image: url({style_images_url}/backgrounds/background3.jpg);'></span>
                    <span data-backgroundImage='background4' data-backgroundColor=\"#1f5168\" data-blurBackgroundColor=\"#8fa8b4\" style='background-image: url({style_images_url}/backgrounds/background4.jpg);'></span>
                </div></div></div>") : ("")) . "
			...
			<div id='content' class='clearfix'>
                ...
                <div id='secondary_navigation' class='clearfix'>
                    <ol class='breadcrumb top ipsList_inline left' id='breadcrumb'>
                            ...
                            " . (($this->did_first=1) ? ("") : ("")) . "") : ("")) . "
                        ".$this->__f__d80cf09a83efdfece883ab6fe88de57f($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."                    </ol>
                ...
                <div class='guestMessage'>
                	<div class='guestHeader'>Добро пожаловать на {$this->settings['board_name']}</div>
                    Вы зашли как гость. Для доступа к полному функционалу форума пожалуйста пройдите регистрацию или авторизируйтесь.<br />
<a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=global&amp;section=login", "public",'' ), "", "" ) . "' class='guestButton'>Авторизация</a> <a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=global&amp;section=register", "public",'' ), "", "" ) . "' class='guestButton'>Регистрация</a>
                </div>
                ") : ("")) . "
				...
				<ol class='breadcrumb bottom ipsList_inline left clearfix clear'>
					" . ((count( $items['navigation'] )) ? ("						" . ((!$this->settings['remove_forums_nav'] OR ipsRegistry::$current_application == 'forums') ? ("<li><a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "act=idx", "public",'' ), "false", "" ) . "'>{$this->settings['board_name']}</a></li>
						...
						".$this->__f__478a691c0aa2a1e1af8df6cbd93ca154($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."") : ("
						<li>&nbsp;</li>
					")) . "
				</ol>
						...
						" . ((count($footer_items['skin_chooser']) > 1) ? ("
							<li>
								...
								<ul id='new_skin_menucontent' class='ipbmenu_content with_checks' style='display: none'>
									".$this->__f__f09810b02956c93fe34f34f98792295a($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."								</ul>
							</li>
						") : ("")) . "")) . "") : ("")) . "
					" . ((! $this->member->is_not_human && count( $footer_items['lang_chooser']['options'] ) > 1) ? ("
						<li>
							...
							<ul id='new_language_menucontent' class='ipbmenu_content with_checks' style='display: none'>
								".$this->__f__f618c5ec1a8b1e0f318d72ff87f1bb22($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."							</ul>
						</li>
					") : ("")) . "
					" . ((( ! $this->member->is_not_human ) && ( $this->memberData['member_id'] || $this->settings['topic_marking_guests'] )) ? ("
						<li>
							...
							<ul id='mark_all_read_menucontent' class='ipbmenu_content' style='display: none'>
								".$this->__f__059b0e5fd31c22fd4865c548219f320b($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."								<li>
...
function __f__43d53cf4170eb33a2b0e7d4a88c8b726($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__d80cf09a83efdfece883ab6fe88de57f($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__478a691c0aa2a1e1af8df6cbd93ca154($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $items['navigation'] as $idx => $data )
...
function __f__f09810b02956c93fe34f34f98792295a($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__f618c5ec1a8b1e0f318d72ff87f1bb22($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__059b0e5fd31c22fd4865c548219f320b($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_f01c79ea1e1f498c8578005f1b6ecc35 = is_array($this->functionData['includeCSS']) ? count($this->functionData['includeCSS']) : 0;
$this->functionData['includeCSS'][$count_f01c79ea1e1f498c8578005f1b6ecc35]['css'] = $css;
}

$this->minify = array();
$IPBHTML .= "" . ((is_array( $css['import'] )) ? ("" . (($this->settings['use_minify']) ? ("") : ("")) . "
	".$this->__f__73b641d9106bb9c7683162c55a1ede78($css)."	" . (($this->settings['use_minify'] AND count($this->minify)) ? ("
...
" . ((is_array( $css['inline'] ) AND count( $css['inline'] )) ? ("
	".$this->__f__19a1f4564e8f039199af3a9918c0fcec($css)."") : ("")) . "
<!--[if lte IE 7]>
...
function __f__73b641d9106bb9c7683162c55a1ede78($css)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__19a1f4564e8f039199af3a9918c0fcec($css)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_15909a8df0182d271bc3287a74e25785 = is_array($this->functionData['includeFeeds']) ? count($this->functionData['includeFeeds']) : 0;
$this->functionData['includeFeeds'][$count_15909a8df0182d271bc3287a74e25785]['documentHeadItems'] = $documentHeadItems;
}
$IPBHTML .= "" . ((count($documentHeadItems)) ? ("
	".$this->__f__733c92fd87837dc98c8b97bb72d091a6($documentHeadItems)."") : ("")) . "";
return $IPBHTML;
}


function __f__11aa8b70fdd7c5763d6c5e1397f32cbb($documentHeadItems,$type='',$idx='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__733c92fd87837dc98c8b97bb72d091a6($documentHeadItems)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems as $type => $idx )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
		".$this->__f__11aa8b70fdd7c5763d6c5e1397f32cbb($documentHeadItems,$type,$idx)."	
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_beb3189cd92e865df0726f574af395f7 = is_array($this->functionData['includeJS']) ? count($this->functionData['includeJS']) : 0;
$this->functionData['includeJS'][$count_beb3189cd92e865df0726f574af395f7]['jsModules'] = $jsModules;
}
...
{
$count_a9d1dc0383ec3bf20462d80bdaa242fc = is_array($this->functionData['includeMeta']) ? count($this->functionData['includeMeta']) : 0;
$this->functionData['includeMeta'][$count_a9d1dc0383ec3bf20462d80bdaa242fc]['metaTags'] = $metaTags;
}
$IPBHTML .= "" . ((is_array( $metaTags ) AND count( $metaTags )) ? ("
	".$this->__f__f8551e00a58a398e2b9078ca96020ac2($metaTags)."") : ("")) . "
<meta property=\"og:image\" content=\"{$this->settings['meta_imagesrc']}\"/>";
return $IPBHTML;
}


function __f__0e7de2ec2e657d3f62004d8a5e275d7e($metaTags,$tag='',$id='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__f8551e00a58a398e2b9078ca96020ac2($metaTags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $metaTags as $tag => $id )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
		".$this->__f__0e7de2ec2e657d3f62004d8a5e275d7e($metaTags,$tag,$id)."	
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_1462f16009b3b52dc5f21d7eae7afdd4 = is_array($this->functionData['includeRTL']) ? count($this->functionData['includeRTL']) : 0;
}

$this->isRtlLang	= false;
$IPBHTML .= "".$this->__f__e41641cec312115175b96cd4777152a1()."" . (($this->isRtlLang AND is_file( DOC_IPS_ROOT_PATH . '/' . PUBLIC_DIRECTORY . '/style_css/' . $this->registry->output->skin['_csscacheid'] . '/ipb_rtl.css' )) ? ("
...
function __f__e41641cec312115175b96cd4777152a1()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_4c4e7ee6ce3feeace7ffcdd95856cb28 = is_array($this->functionData['includeVars']) ? count($this->functionData['includeVars']) : 0;
$this->functionData['includeVars'][$count_4c4e7ee6ce3feeace7ffcdd95856cb28]['header_items'] = $header_items;
}
...
{
$count_2076622b2c945f649a5a83cefd2f9d0f = is_array($this->functionData['inlineLogin']) ? count($this->functionData['inlineLogin']) : 0;
}
					...
					<ul class='ipsList_inline'>
						...
						") : ("")) . "
							" . ((is_array($this->_formFields) AND count($this->_formFields)) ? ("
								".$this->__f__30827ee4401c400d6661b86a8afa53dc()."							") : ("")) . "
					</ul>
				</div>") : ("")) . "
...
function __f__30827ee4401c400d6661b86a8afa53dc()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_5a3ad446b8c8034ae504994a9df46521 = is_array($this->functionData['liveEditJs']) ? count($this->functionData['liveEditJs']) : 0;
}
...
<div class='ipsBox ipsPad'>
	...
	<form action='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&module=global&section=meta&do=save", "public",'' ), "", "" ) . "' method='post'>
		...
		<table class='ipb_table'>
			".$this->__f__65c361ddc03f1e7cd8b96d00deaa38d3($tags,$url)."		</table>
		</div>
		<table class='ipb_table'>
			<tr>
...
function __f__65c361ddc03f1e7cd8b96d00deaa38d3($tags, $url)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $tags as $k => $v )
...
{
$count_20ab6c8b95f1a0f226b821eb83898d14 = is_array($this->functionData['nextPreviousTemplate']) ? count($this->functionData['nextPreviousTemplate']) : 0;
$this->functionData['nextPreviousTemplate'][$count_20ab6c8b95f1a0f226b821eb83898d14]['data'] = $data;
}
...
{
$count_9225ff477b4a4f05c72dc4f3481f7175 = is_array($this->functionData['paginationTemplate']) ? count($this->functionData['paginationTemplate']) : 0;
$this->functionData['paginationTemplate'][$count_9225ff477b4a4f05c72dc4f3481f7175]['work'] = $work;
$this->functionData['paginationTemplate'][$count_9225ff477b4a4f05c72dc4f3481f7175]['data'] = $data;
}
$IPBHTML .= "" . (($work['pages'] > 1) ? ("<div class='pagination clearfix left " . ((!$data['showNumbers']) ? ("no_numbers") : ("")) . "'>
		...
		<ul class='ipsList_inline left pages'>
			...
			" . ((is_array( $work['_pageNumbers'] ) && count( $work['_pageNumbers'] )) ? ("
				".$this->__f__9b316256df1d892115639aa3eb36de5f($work,$data)."			") : ("")) . "
		</ul>
...
function __f__9b316256df1d892115639aa3eb36de5f($work, $data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_0b75e463ed859c748b90dcd2cfb190bf = is_array($this->functionData['quickSearch']) ? count($this->functionData['quickSearch']) : 0;
}
...
function __f__9d8da4a2115a417db2ca737a1f984688()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_abb1910cfac31f957f00e897043eb9fc = is_array($this->functionData['shareLinks']) ? count($this->functionData['shareLinks']) : 0;
$this->functionData['shareLinks'][$count_abb1910cfac31f957f00e897043eb9fc]['links'] = $links;
$this->functionData['shareLinks'][$count_abb1910cfac31f957f00e897043eb9fc]['title'] = $title;
$this->functionData['shareLinks'][$count_abb1910cfac31f957f00e897043eb9fc]['url'] = $url;
$this->functionData['shareLinks'][$count_abb1910cfac31f957f00e897043eb9fc]['cssClass'] = $cssClass;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("sharelinks", "0" ) . "
" . ((is_array( $links )) ? ("
	<ul class='{$cssClass} shareButtons ipsList_inline'>
	".$this->__f__6b814b73f940f4a7ec80fdb0f89563d3($links,$title,$url,$cssClass)."	</ul>
	<script type=\"text/javascript\">
...
function __f__6b814b73f940f4a7ec80fdb0f89563d3($links, $title='', $url='', $cssClass='topic_share left')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_65bfb4b583a3d1cad2d0c66ca75dde59 = is_array($this->functionData['signature_separator']) ? count($this->functionData['signature_separator']) : 0;
$this->functionData['signature_separator'][$count_65bfb4b583a3d1cad2d0c66ca75dde59]['sig'] = $sig;
$this->functionData['signature_separator'][$count_65bfb4b583a3d1cad2d0c66ca75dde59]['author_id'] = $author_id;
$this->functionData['signature_separator'][$count_65bfb4b583a3d1cad2d0c66ca75dde59]['can_ignore'] = $can_ignore;
}
...
{
$count_6b28d0988a4b1e6b6cb521a09b6c16fe = is_array($this->functionData['userHoverCard']) ? count($this->functionData['userHoverCard']) : 0;
$this->functionData['userHoverCard'][$count_6b28d0988a4b1e6b6cb521a09b6c16fe]['member'] = $member;
}
...
{
$count_84710c4e50a9e82ab0111a731acb6db6 = is_array($this->functionData['userInfoPane']) ? count($this->functionData['userInfoPane']) : 0;
$this->functionData['userInfoPane'][$count_84710c4e50a9e82ab0111a731acb6db6]['author'] = $author;
$this->functionData['userInfoPane'][$count_84710c4e50a9e82ab0111a731acb6db6]['contentid'] = $contentid;
$this->functionData['userInfoPane'][$count_84710c4e50a9e82ab0111a731acb6db6]['options'] = $options;
}
...
" . ((($this->settings['horizontalTopicView']=='yes') AND $this->request['section'] == 'topics') ? ("<div class='horizontalAvatar left'>
	...
	" . (($author['custom_fields'] != "") ? ("
		<ul class='horizontalInfoList custom_fields'>
			".$this->__f__a5d2da6384f9e45870288efe4dcdb06d($author,$contentid,$options)."		</ul>
	") : ("")) . "
	...
	" . (($author['custom_fields'] != "") ? ("
		<ul class='custom_fields'>
			".$this->__f__a8826e8e9892665957fbb1acee8b599c($author,$contentid,$options)."		</ul>
	") : ("")) . "")) . "
...
function __f__5e02c942fe91d09c9ea375d1d9c61b7c($author, $contentid, $options,$group='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__a5d2da6384f9e45870288efe4dcdb06d($author, $contentid, $options)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $author['custom_fields'] as $group => $data )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
				".$this->__f__5e02c942fe91d09c9ea375d1d9c61b7c($author,$contentid,$options,$group,$data)."			
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
function __f__a662df4d71f28708d91e05b81647acb3($author, $contentid, $options,$group='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $author['custom_fields'][ $group ] as $field )
...
function __f__a8826e8e9892665957fbb1acee8b599c($author, $contentid, $options)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $author['custom_fields'] as $group => $data )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
				".$this->__f__a662df4d71f28708d91e05b81647acb3($author,$contentid,$options,$group,$data)."			
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_bcfc568bea00529de3b929afb7f3eda2 = is_array($this->functionData['userSmallPhoto']) ? count($this->functionData['userSmallPhoto']) : 0;
$this->functionData['userSmallPhoto'][$count_bcfc568bea00529de3b929afb7f3eda2]['member'] = $member;
}
...
{
$count_60dde7cee4e648bd38ca3da0bc053a24 = is_array($this->functionData['warnDetails']) ? count($this->functionData['warnDetails']) : 0;
$this->functionData['warnDetails'][$count_60dde7cee4e648bd38ca3da0bc053a24]['warning'] = $warning;
$this->functionData['warnDetails'][$count_60dde7cee4e648bd38ca3da0bc053a24]['canSeeModNote'] = $canSeeModNote;
}
...
<div class='ipsBox'>
	<p class='message unspecific'>
		...
		") : ("" . (($warning['wl_points']) ? ("" . (($warning['wl_expire']) ? ("" . (($warning['wl_expire_date']) ? ("
				...
				")) . "") : ("")) . "
			".$this->__f__0d271ebdf7074f261ce385bce47da519($warning,$canSeeModNote)."")) . "
	</p>
...
function __f__0d271ebdf7074f261ce385bce47da519($warning, $canSeeModNote)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
