...
{
$count_9e8fef23e45bffd6c5a2af53255bce08 = is_array($this->functionData['completePartialLogin']) ? count($this->functionData['completePartialLogin']) : 0;
$this->functionData['completePartialLogin'][$count_9e8fef23e45bffd6c5a2af53255bce08]['mid'] = $mid;
$this->functionData['completePartialLogin'][$count_9e8fef23e45bffd6c5a2af53255bce08]['key'] = $key;
$this->functionData['completePartialLogin'][$count_9e8fef23e45bffd6c5a2af53255bce08]['custom_fields'] = $custom_fields;
$this->functionData['completePartialLogin'][$count_9e8fef23e45bffd6c5a2af53255bce08]['errors'] = $errors;
$this->functionData['completePartialLogin'][$count_9e8fef23e45bffd6c5a2af53255bce08]['reg'] = $reg;
$this->functionData['completePartialLogin'][$count_9e8fef23e45bffd6c5a2af53255bce08]['userFromService'] = $userFromService;
}
	...
	<div class='post_form'>
		...
		" . (($custom_fields != '') ? ("<fieldset class='row1'>
				...
				" . ((is_array( $custom_fields['required'] ) && count( $custom_fields['required'] )) ? ("
					".$this->__f__11bf616b5fdd412dd9c90a35b1a34eed($mid,$key,$custom_fields,$errors,$reg,$userFromService)."				") : ("")) . "
				
				" . ((is_array( $custom_fields['optional'] ) && count( $custom_fields['optional'] )) ? ("
					".$this->__f__1c3899084629608279b2de9479d8384d($mid,$key,$custom_fields,$errors,$reg,$userFromService)."				") : ("")) . "
			</fieldset>") : ("")) . "
...
function __f__11bf616b5fdd412dd9c90a35b1a34eed($mid="",$key="",$custom_fields="",$errors="", $reg="", $userFromService=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__1c3899084629608279b2de9479d8384d($mid="",$key="",$custom_fields="",$errors="", $reg="", $userFromService=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_740e34db2e8807ac0d3747ccb299e3a0 = is_array($this->functionData['lostPasswordForm']) ? count($this->functionData['lostPasswordForm']) : 0;
$this->functionData['lostPasswordForm'][$count_740e34db2e8807ac0d3747ccb299e3a0]['errors'] = $errors;
}
...
{
$count_5d1d8855dd7177c74c34db878eb2d34c = is_array($this->functionData['registerCoppaForm']) ? count($this->functionData['registerCoppaForm']) : 0;
}
$IPBHTML .= "<html>
	<head>
...
{
$count_dd5de3f763dac7c20d2cb028a257e642 = is_array($this->functionData['registerCoppaStart']) ? count($this->functionData['registerCoppaStart']) : 0;
}
		...
		<div class='row post line_spacing'>
			...
			<br /><br />
				<select name='month' id='coppa_bday_m'>
					".$this->__f__62a8fe5b6ff38cd5450847d71ebabee9()."				</select>
				&nbsp;
				<select name='day' id='coppa_bday_d'>
					".$this->__f__e8220314ed09c245c5f3f47338fa9ee5()."				</select>
				&nbsp;
				<select name='year' id='coppa_bday_y'>
					".$this->__f__ad9a798e0d7ba5ecaf03479eaa2d4db4()."				</select>
			</div>
		<div class='submit'>
...
function __f__62a8fe5b6ff38cd5450847d71ebabee9()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__e8220314ed09c245c5f3f47338fa9ee5()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__ad9a798e0d7ba5ecaf03479eaa2d4db4()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_b4ff4b8db4d6c805b2d701cb29de09fd = is_array($this->functionData['registerForm']) ? count($this->functionData['registerForm']) : 0;
$this->functionData['registerForm'][$count_b4ff4b8db4d6c805b2d701cb29de09fd]['general_errors'] = $general_errors;
$this->functionData['registerForm'][$count_b4ff4b8db4d6c805b2d701cb29de09fd]['data'] = $data;
$this->functionData['registerForm'][$count_b4ff4b8db4d6c805b2d701cb29de09fd]['inline_errors'] = $inline_errors;
$this->functionData['registerForm'][$count_b4ff4b8db4d6c805b2d701cb29de09fd]['time_select'] = $time_select;
$this->functionData['registerForm'][$count_b4ff4b8db4d6c805b2d701cb29de09fd]['custom_fields'] = $custom_fields;
$this->functionData['registerForm'][$count_b4ff4b8db4d6c805b2d701cb29de09fd]['nexusFields'] = $nexusFields;
$this->functionData['registerForm'][$count_b4ff4b8db4d6c805b2d701cb29de09fd]['nexusStates'] = $nexusStates;
}
	...
	") : ("<div class='master_list'>
			...
			" . ((is_array( $general_errors ) && count( $general_errors )) ? ("
				<div class='message error'>
					...
					".$this->__f__048a8468fbdc95f5384311e53db1a571($general_errors,$data,$inline_errors,$time_select,$custom_fields,$nexusFields,$nexusStates)."				</div>
			") : ("")) . "
			...
			<form class='ipsForm_vertical' action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=global&amp;section=register", "public",'' ), "", "" ) . "\" method=\"post\" name=\"REG\" id='register'>
				...
				" . ((( is_array( $custom_fields['required'] ) && count( $custom_fields['required'] ) ) || ( is_array( $custom_fields['optional'] ) && count( $custom_fields['optional'] ) )) ? ("<div class='row line_spacing'>
						" . ((is_array( $custom_fields['required'] ) && count( $custom_fields['required'] )) ? ("
							".$this->__f__3da29a2a266aa1181d44027b9c13e8cc($general_errors,$data,$inline_errors,$time_select,$custom_fields,$nexusFields,$nexusStates)."						") : ("")) . "
				
						" . ((is_array( $custom_fields['optional'] ) && count( $custom_fields['optional'] )) ? ("
							".$this->__f__941f2f1bb7e6cadb59f785dcc667e2b5($general_errors,$data,$inline_errors,$time_select,$custom_fields,$nexusFields,$nexusStates)."						") : ("")) . "
						<!--IBF.MODULES.EXTRA-->
					</div>") : ("")) . "
...
function __f__048a8468fbdc95f5384311e53db1a571($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array(), $nexusFields=array(), $nexusStates=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__3da29a2a266aa1181d44027b9c13e8cc($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array(), $nexusFields=array(), $nexusStates=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $custom_fields['required'] as $_field )
...
function __f__941f2f1bb7e6cadb59f785dcc667e2b5($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array(), $nexusFields=array(), $nexusStates=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $custom_fields['optional'] as $_field )
...
{
$count_ba332fd3e4a959e39acdd3c1c3b4e9bd = is_array($this->functionData['showLostpassForm']) ? count($this->functionData['showLostpassForm']) : 0;
$this->functionData['showLostpassForm'][$count_ba332fd3e4a959e39acdd3c1c3b4e9bd]['error'] = $error;
}
...
{
$count_5db0397d6fdc80f8a90c9241a19e7e06 = is_array($this->functionData['showRevalidateForm']) ? count($this->functionData['showRevalidateForm']) : 0;
$this->functionData['showRevalidateForm'][$count_5db0397d6fdc80f8a90c9241a19e7e06]['name'] = $name;
$this->functionData['showRevalidateForm'][$count_5db0397d6fdc80f8a90c9241a19e7e06]['error'] = $error;
}
$IPBHTML .= "<h2>{$this->lang->words['rv_title']}</h2>
" . (($error) ? ("
