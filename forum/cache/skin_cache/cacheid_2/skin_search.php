...
{
$count_6deb7cf6b22541087908fcf67dca606c = is_array($this->functionData['asForumPosts']) ? count($this->functionData['asForumPosts']) : 0;
$this->functionData['asForumPosts'][$count_6deb7cf6b22541087908fcf67dca606c]['data'] = $data;
}
$IPBHTML .= "<div class='row'>
	...
	{$this->lang->words['in']}
	".$this->__f__cac15c5302715f8007cbe69c003e8c68($data)."	
	" . ((isset( $data['pages'] ) AND is_array( $data['pages'] ) AND count( $data['pages'] )) ? ("
		<span class='mini_pagination'>
			".$this->__f__443acc5650efdcfa7ca5fe697962a58a($data)."		</span>
	") : ("")) . "
	<br />
...
function __f__cac15c5302715f8007cbe69c003e8c68($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__443acc5650efdcfa7ca5fe697962a58a($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_94184eed79c79a7ef1d24709422a18fb = is_array($this->functionData['asForumTopics']) ? count($this->functionData['asForumTopics']) : 0;
$this->functionData['asForumTopics'][$count_94184eed79c79a7ef1d24709422a18fb]['data'] = $data;
}
$IPBHTML .= "<div class='row touch-row " . ((!empty( $data['_unreadUrl'] )) ? ("unread") : ("")) . "' id=\"sr-{$data['type_id_2']}\">
	...
	<div class='rowContent'>
		...
		") : ("")) . "
		<div>
			" . ucfirst($this->lang->words['in']) . "".$this->__f__3cf66a1aeb202978191e05eb033c097f($data)."		</div>
...
function __f__3cf66a1aeb202978191e05eb033c097f($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $data['_forum_trail'] as $i => $f )
...
{
$count_088a4d062322275d3258dc94e5b0c248 = is_array($this->functionData['followData']) ? count($this->functionData['followData']) : 0;
$this->functionData['followData'][$count_088a4d062322275d3258dc94e5b0c248]['followData'] = $followData;
}
...
{
$count_c60bc557cd24be48e8c134dd6c962bdd = is_array($this->functionData['followedContentForumsWrapper']) ? count($this->functionData['followedContentForumsWrapper']) : 0;
$this->functionData['followedContentForumsWrapper'][$count_c60bc557cd24be48e8c134dd6c962bdd]['results'] = $results;
}
$IPBHTML .= "" . ((count($results)) ? ("".$this->__f__41d684c803403fdb43f005093c317cac($results)."") : ("")) . "";
return $IPBHTML;
}


function __f__41d684c803403fdb43f005093c317cac($results)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_400798eca0fc9ce43691a26c79b9e168 = is_array($this->functionData['followedContentForumsWrapperForums']) ? count($this->functionData['followedContentForumsWrapperForums']) : 0;
$this->functionData['followedContentForumsWrapperForums'][$count_400798eca0fc9ce43691a26c79b9e168]['results'] = $results;
}
...
<div class='master_list'>
	".$this->__f__6698a1928d7245cdc046840cbd898a94($results)."</div>";
return $IPBHTML;
}


function __f__6698a1928d7245cdc046840cbd898a94($results)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_2338357b3d7479fc4c812b57cda13480 = is_array($this->functionData['followedContentView']) ? count($this->functionData['followedContentView']) : 0;
$this->functionData['followedContentView'][$count_2338357b3d7479fc4c812b57cda13480]['results'] = $results;
$this->functionData['followedContentView'][$count_2338357b3d7479fc4c812b57cda13480]['pagination'] = $pagination;
$this->functionData['followedContentView'][$count_2338357b3d7479fc4c812b57cda13480]['total'] = $total;
$this->functionData['followedContentView'][$count_2338357b3d7479fc4c812b57cda13480]['error'] = $error;
$this->functionData['followedContentView'][$count_2338357b3d7479fc4c812b57cda13480]['contentTypes'] = $contentTypes;
}
$IPBHTML .= "" . (($pagination) ? ("
<div class='controls'>
...
<div class='master_list'>
	...
	<div class='ipsPad'>
		...
		".$this->__f__3a01d36b566101cd3d49f2930518d76b($results,$pagination,$total,$error,$contentTypes)."		</ul>
	</div>
</div>
<div class='master_list'>
	...
	<div class='ipsPad'>
		<ul>
			".$this->__f__cf513b4d071e03752c6299432b3d4683($results,$pagination,$total,$error,$contentTypes)."		</ul>
	</div>
</div>";
return $IPBHTML;
}
...
function __f__3a01d36b566101cd3d49f2930518d76b($results, $pagination, $total, $error, $contentTypes)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__cf513b4d071e03752c6299432b3d4683($results, $pagination, $total, $error, $contentTypes)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_a749497316f2db772d5dd578796fc12c = is_array($this->functionData['forumAdvancedSearchFilters']) ? count($this->functionData['forumAdvancedSearchFilters']) : 0;
$this->functionData['forumAdvancedSearchFilters'][$count_a749497316f2db772d5dd578796fc12c]['forums'] = $forums;
$this->functionData['forumAdvancedSearchFilters'][$count_a749497316f2db772d5dd578796fc12c]['archivedPostCount'] = $archivedPostCount;
$this->functionData['forumAdvancedSearchFilters'][$count_a749497316f2db772d5dd578796fc12c]['topic'] = $topic;
}
...
{
$count_953350b862986dec9b74a903617b7763 = is_array($this->functionData['forumsVncFilters']) ? count($this->functionData['forumsVncFilters']) : 0;
$this->functionData['forumsVncFilters'][$count_953350b862986dec9b74a903617b7763]['data'] = $data;
$this->functionData['forumsVncFilters'][$count_953350b862986dec9b74a903617b7763]['currentPrefs'] = $currentPrefs;
}
...
{
$count_08fea3435bb1b131dce2987b64d9efcb = is_array($this->functionData['helpSearchResult']) ? count($this->functionData['helpSearchResult']) : 0;
$this->functionData['helpSearchResult'][$count_08fea3435bb1b131dce2987b64d9efcb]['r'] = $r;
$this->functionData['helpSearchResult'][$count_08fea3435bb1b131dce2987b64d9efcb]['resultAsTitle'] = $resultAsTitle;
}
...
{
$count_ffe4d835e9afe47578755787a66deea4 = is_array($this->functionData['memberCommentsSearchResult']) ? count($this->functionData['memberCommentsSearchResult']) : 0;
$this->functionData['memberCommentsSearchResult'][$count_ffe4d835e9afe47578755787a66deea4]['r'] = $r;
$this->functionData['memberCommentsSearchResult'][$count_ffe4d835e9afe47578755787a66deea4]['resultAsTitle'] = $resultAsTitle;
}
...
{
$count_f86755d8ed5c6b175a9a0aeeeb1b9b4b = is_array($this->functionData['newContentView']) ? count($this->functionData['newContentView']) : 0;
$this->functionData['newContentView'][$count_f86755d8ed5c6b175a9a0aeeeb1b9b4b]['results'] = $results;
$this->functionData['newContentView'][$count_f86755d8ed5c6b175a9a0aeeeb1b9b4b]['pagination'] = $pagination;
$this->functionData['newContentView'][$count_f86755d8ed5c6b175a9a0aeeeb1b9b4b]['total'] = $total;
$this->functionData['newContentView'][$count_f86755d8ed5c6b175a9a0aeeeb1b9b4b]['sortDropDown'] = $sortDropDown;
$this->functionData['newContentView'][$count_f86755d8ed5c6b175a9a0aeeeb1b9b4b]['sortIn'] = $sortIn;
$this->functionData['newContentView'][$count_f86755d8ed5c6b175a9a0aeeeb1b9b4b]['dateCutSet'] = $dateCutSet;
}
...
" . ((is_array($sortIn) AND count( $sortIn )) ? ("
	<div class='ipsFilterPane' id='filter_section_pane' style='display: none'>
		...
		<div>
			...
			<ul>
				".$this->__f__8b6a603983e4eef49917dd2fabcf5e34($results,$pagination,$total,$sortDropDown,$sortIn,$dateCutSet)."			</ul>
		</div>
	</div>
") : ("")) . "
...
function __f__0e5f59c5270f3290a2c378cf20734a27($results, $pagination, $total, $sortDropDown, $sortIn, $dateCutSet=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $this->registry->getApplications() as $app )
...
function __f__8b6a603983e4eef49917dd2fabcf5e34($results, $pagination, $total, $sortDropDown, $sortIn, $dateCutSet=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_63fe2455f8cdd549fc46933265eed70b = is_array($this->functionData['searchAdvancedForm']) ? count($this->functionData['searchAdvancedForm']) : 0;
$this->functionData['searchAdvancedForm'][$count_63fe2455f8cdd549fc46933265eed70b]['filters'] = $filters;
$this->functionData['searchAdvancedForm'][$count_63fe2455f8cdd549fc46933265eed70b]['msg'] = $msg;
$this->functionData['searchAdvancedForm'][$count_63fe2455f8cdd549fc46933265eed70b]['current_app'] = $current_app;
$this->functionData['searchAdvancedForm'][$count_63fe2455f8cdd549fc46933265eed70b]['removed_search_terms'] = $removed_search_terms;
$this->functionData['searchAdvancedForm'][$count_63fe2455f8cdd549fc46933265eed70b]['isFT'] = $isFT;
$this->functionData['searchAdvancedForm'][$count_63fe2455f8cdd549fc46933265eed70b]['canTag'] = $canTag;
}
...
<div class='master_list ipsForm_vertical'>
	...
	" . ((count($filters)) ? ("".$this->__f__def80a61a49a9b38273a0937f08d8b6e($filters,$msg,$current_app,$removed_search_terms,$isFT,$canTag)."		") : ("")) . "
	<div class='submit'>
...
function __f__db788bf477601c10aee853dd17dc7836($filters='', $msg='', $current_app, $removed_search_terms=array(), $isFT=false, $canTag=array(),$app='',$data='',$id='',$_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__6fc41028e694dfdbd958da47e587f39b($filters='', $msg='', $current_app, $removed_search_terms=array(), $isFT=false, $canTag=array(),$app='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
		...
		$_ips___x_retval .= "
							<ul>
								<li>
									...
									".$this->__f__db788bf477601c10aee853dd17dc7836($filters,$msg,$current_app,$removed_search_terms,$isFT,$canTag,$app,$data,$id,$_data)."									</select>
...
function __f__0a2b74269a534d9c020435cc20b5d6dc($filters='', $msg='', $current_app, $removed_search_terms=array(), $isFT=false, $canTag=array(),$app='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__def80a61a49a9b38273a0937f08d8b6e($filters='', $msg='', $current_app, $removed_search_terms=array(), $isFT=false, $canTag=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
		...
		$_ips___x_retval .= "
			" . (($app == 'forums') ? ("<div id='app_filter_{$app}'>
				...
				" . ((count($data['sortDropDown'])) ? ("" . ((is_array($data['sortDropIn']) AND count( $data['sortDropIn'] )) ? ("
						".$this->__f__6fc41028e694dfdbd958da47e587f39b($filters,$msg,$current_app,$removed_search_terms,$isFT,$canTag,$app,$data)."					") : ("<div class='ipsField'>
							...
							<select name='search_app_filters[$app][sortKey]' id='search_sort_by_{$app}' class='input_select' style='width:auto'>
								".$this->__f__0a2b74269a534d9c020435cc20b5d6dc($filters,$msg,$current_app,$removed_search_terms,$isFT,$canTag,$app,$data)."							</select>
...
{
$count_2bb0d19a01d870c23941d29fc1120871 = is_array($this->functionData['searchResults']) ? count($this->functionData['searchResults']) : 0;
$this->functionData['searchResults'][$count_2bb0d19a01d870c23941d29fc1120871]['results'] = $results;
$this->functionData['searchResults'][$count_2bb0d19a01d870c23941d29fc1120871]['titlesOnly'] = $titlesOnly;
}
...
$IPBHTML .= "<div id='search_results'>
	<ol>
		" . ((is_array($results) && count($results)) ? ("
			".$this->__f__de64bd456b31c180dc5de39c9aa5bbb6($results,$titlesOnly)."		") : ("")) . "
	</ol>
</div>";
return $IPBHTML;
}
...
function __f__de64bd456b31c180dc5de39c9aa5bbb6($results, $titlesOnly)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $results as $result )
...
{
$count_ceb103146f6d00e13bd85cf1c70ddca3 = is_array($this->functionData['searchResultsAsForum']) ? count($this->functionData['searchResultsAsForum']) : 0;
$this->functionData['searchResultsAsForum'][$count_ceb103146f6d00e13bd85cf1c70ddca3]['results'] = $results;
$this->functionData['searchResultsAsForum'][$count_ceb103146f6d00e13bd85cf1c70ddca3]['titlesOnly'] = $titlesOnly;
}
...
{
$count_f3bcf3a8caf61860036c3ae107445973 = is_array($this->functionData['searchResultsWrapper']) ? count($this->functionData['searchResultsWrapper']) : 0;
$this->functionData['searchResultsWrapper'][$count_f3bcf3a8caf61860036c3ae107445973]['results'] = $results;
$this->functionData['searchResultsWrapper'][$count_f3bcf3a8caf61860036c3ae107445973]['sortDropDown'] = $sortDropDown;
$this->functionData['searchResultsWrapper'][$count_f3bcf3a8caf61860036c3ae107445973]['sortIn'] = $sortIn;
$this->functionData['searchResultsWrapper'][$count_f3bcf3a8caf61860036c3ae107445973]['pagination'] = $pagination;
$this->functionData['searchResultsWrapper'][$count_f3bcf3a8caf61860036c3ae107445973]['total'] = $total;
$this->functionData['searchResultsWrapper'][$count_f3bcf3a8caf61860036c3ae107445973]['showing'] = $showing;
$this->functionData['searchResultsWrapper'][$count_f3bcf3a8caf61860036c3ae107445973]['search_term'] = $search_term;
$this->functionData['searchResultsWrapper'][$count_f3bcf3a8caf61860036c3ae107445973]['url_string'] = $url_string;
$this->functionData['searchResultsWrapper'][$count_f3bcf3a8caf61860036c3ae107445973]['current_key'] = $current_key;
$this->functionData['searchResultsWrapper'][$count_f3bcf3a8caf61860036c3ae107445973]['removed_search_terms'] = $removed_search_terms;
$this->functionData['searchResultsWrapper'][$count_f3bcf3a8caf61860036c3ae107445973]['limited'] = $limited;
$this->functionData['searchResultsWrapper'][$count_f3bcf3a8caf61860036c3ae107445973]['wasLimited'] = $wasLimited;
$this->functionData['searchResultsWrapper'][$count_f3bcf3a8caf61860036c3ae107445973]['search_tags'] = $search_tags;
}
...
{
$count_d14f47c348b1b6625d05f3bb9278f6d4 = is_array($this->functionData['searchRowGenericFormat']) ? count($this->functionData['searchRowGenericFormat']) : 0;
$this->functionData['searchRowGenericFormat'][$count_d14f47c348b1b6625d05f3bb9278f6d4]['r'] = $r;
$this->functionData['searchRowGenericFormat'][$count_d14f47c348b1b6625d05f3bb9278f6d4]['resultAsTitle'] = $resultAsTitle;
}
$IPBHTML .= "<div class='result_info'>
...
{
$count_8a668eccfe53cf8f704d22a44b673b61 = is_array($this->functionData['topicPostSearchResultAsForum']) ? count($this->functionData['topicPostSearchResultAsForum']) : 0;
$this->functionData['topicPostSearchResultAsForum'][$count_8a668eccfe53cf8f704d22a44b673b61]['data'] = $data;
$this->functionData['topicPostSearchResultAsForum'][$count_8a668eccfe53cf8f704d22a44b673b61]['resultAsTitle'] = $resultAsTitle;
}
...
{
$count_fcf9769481de995c1ab9ea4d8d789732 = is_array($this->functionData['userPostsView']) ? count($this->functionData['userPostsView']) : 0;
$this->functionData['userPostsView'][$count_fcf9769481de995c1ab9ea4d8d789732]['results'] = $results;
$this->functionData['userPostsView'][$count_fcf9769481de995c1ab9ea4d8d789732]['pagination'] = $pagination;
$this->functionData['userPostsView'][$count_fcf9769481de995c1ab9ea4d8d789732]['total'] = $total;
$this->functionData['userPostsView'][$count_fcf9769481de995c1ab9ea4d8d789732]['member'] = $member;
$this->functionData['userPostsView'][$count_fcf9769481de995c1ab9ea4d8d789732]['limited'] = $limited;
$this->functionData['userPostsView'][$count_fcf9769481de995c1ab9ea4d8d789732]['wasLimited'] = $wasLimited;
$this->functionData['userPostsView'][$count_fcf9769481de995c1ab9ea4d8d789732]['beginTime'] = $beginTime;
$this->functionData['userPostsView'][$count_fcf9769481de995c1ab9ea4d8d789732]['sortIn'] = $sortIn;
$this->functionData['userPostsView'][$count_fcf9769481de995c1ab9ea4d8d789732]['sortDropDown'] = $sortDropDown;
}
