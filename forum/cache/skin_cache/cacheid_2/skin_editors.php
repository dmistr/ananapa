...
{
$count_e4fe1aa52fa5dd52896f47458ccaa8ce = is_array($this->functionData['ajaxEditBox']) ? count($this->functionData['ajaxEditBox']) : 0;
$this->functionData['ajaxEditBox'][$count_e4fe1aa52fa5dd52896f47458ccaa8ce]['post'] = $post;
$this->functionData['ajaxEditBox'][$count_e4fe1aa52fa5dd52896f47458ccaa8ce]['pid'] = $pid;
$this->functionData['ajaxEditBox'][$count_e4fe1aa52fa5dd52896f47458ccaa8ce]['error_msg'] = $error_msg;
$this->functionData['ajaxEditBox'][$count_e4fe1aa52fa5dd52896f47458ccaa8ce]['extraData'] = $extraData;
}
...
{
$count_cd43dc3caad06c78b3224d56000ed355 = is_array($this->functionData['editor']) ? count($this->functionData['editor']) : 0;
$this->functionData['editor'][$count_cd43dc3caad06c78b3224d56000ed355]['formField'] = $formField;
$this->functionData['editor'][$count_cd43dc3caad06c78b3224d56000ed355]['content'] = $content;
$this->functionData['editor'][$count_cd43dc3caad06c78b3224d56000ed355]['options'] = $options;
$this->functionData['editor'][$count_cd43dc3caad06c78b3224d56000ed355]['autoSaveData'] = $autoSaveData;
$this->functionData['editor'][$count_cd43dc3caad06c78b3224d56000ed355]['warningInfo'] = $warningInfo;
$this->functionData['editor'][$count_cd43dc3caad06c78b3224d56000ed355]['acknowledge'] = $acknowledge;
$this->functionData['editor'][$count_cd43dc3caad06c78b3224d56000ed355]['bbcodeVersion'] = $bbcodeVersion;
$this->functionData['editor'][$count_cd43dc3caad06c78b3224d56000ed355]['showEditor'] = $showEditor;
}
...
{
$count_bb26c8d91def1514714537c31e39f50d = is_array($this->functionData['editorLoadJs']) ? count($this->functionData['editorLoadJs']) : 0;
$this->functionData['editorLoadJs'][$count_bb26c8d91def1514714537c31e39f50d]['options'] = $options;
$this->functionData['editorLoadJs'][$count_bb26c8d91def1514714537c31e39f50d]['inlineLoad'] = $inlineLoad;
}
$IPBHTML .= "<!--no data in this master skin-->";
return $IPBHTML;
}
...
{
$count_77596f4aa3c26dd6a04fefc232031dd8 = is_array($this->functionData['editorSettings']) ? count($this->functionData['editorSettings']) : 0;
}
...
{
$count_5ce8d62cea9d0af197814fa0a6281b0b = is_array($this->functionData['mediaGenericWrapper']) ? count($this->functionData['mediaGenericWrapper']) : 0;
$this->functionData['mediaGenericWrapper'][$count_5ce8d62cea9d0af197814fa0a6281b0b]['rows'] = $rows;
$this->functionData['mediaGenericWrapper'][$count_5ce8d62cea9d0af197814fa0a6281b0b]['pages'] = $pages;
$this->functionData['mediaGenericWrapper'][$count_5ce8d62cea9d0af197814fa0a6281b0b]['app'] = $app;
$this->functionData['mediaGenericWrapper'][$count_5ce8d62cea9d0af197814fa0a6281b0b]['plugin'] = $plugin;
}
...
<div>
	<ul class='media_results'>
		" . ((count($rows)) ? ("
			".$this->__f__c8a438803f5b13399a2bf5446c9831bc($rows,$pages,$app,$plugin)."		") : ("
...
function __f__c8a438803f5b13399a2bf5446c9831bc($rows, $pages, $app, $plugin)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $row )
...
{
$count_bd98524f752ac033960b07a9ef991b59 = is_array($this->functionData['sharedMedia']) ? count($this->functionData['sharedMedia']) : 0;
$this->functionData['sharedMedia'][$count_bd98524f752ac033960b07a9ef991b59]['tabs'] = $tabs;
}
...
<div class='fixed_inner ipsBox'>
	...
	<div class='ipsVerticalTabbed ipsLayout ipsLayout_withleft ipsLayout_smallleft clearfix'>
		<div class='ipsVerticalTabbed_tabs ipsLayout_left'>
			<ul id='mymedia_tabs'>
				".$this->__f__bfa2e89adeb15e211f52929d9a0bbf4b($tabs)."			</ul>
		</div>
...
function __f__bfa2e89adeb15e211f52929d9a0bbf4b($tabs)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $tabs as $tab )
