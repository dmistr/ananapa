...
{
$count_25725162a82015ffd6e37654315d6bf8 = is_array($this->functionData['comment']) ? count($this->functionData['comment']) : 0;
$this->functionData['comment'][$count_25725162a82015ffd6e37654315d6bf8]['r'] = $r;
$this->functionData['comment'][$count_25725162a82015ffd6e37654315d6bf8]['parent'] = $parent;
$this->functionData['comment'][$count_25725162a82015ffd6e37654315d6bf8]['settings'] = $settings;
}
...
{
$count_9f79d7f2dc8f685c667e03762e0feb06 = is_array($this->functionData['commentHidden']) ? count($this->functionData['commentHidden']) : 0;
$this->functionData['commentHidden'][$count_9f79d7f2dc8f685c667e03762e0feb06]['r'] = $r;
$this->functionData['commentHidden'][$count_9f79d7f2dc8f685c667e03762e0feb06]['parent'] = $parent;
$this->functionData['commentHidden'][$count_9f79d7f2dc8f685c667e03762e0feb06]['settings'] = $settings;
}
...
{
$count_243b6ee176a77a72740bd2cae286858e = is_array($this->functionData['commentsList']) ? count($this->functionData['commentsList']) : 0;
$this->functionData['commentsList'][$count_243b6ee176a77a72740bd2cae286858e]['comments'] = $comments;
$this->functionData['commentsList'][$count_243b6ee176a77a72740bd2cae286858e]['settings'] = $settings;
$this->functionData['commentsList'][$count_243b6ee176a77a72740bd2cae286858e]['pages'] = $pages;
$this->functionData['commentsList'][$count_243b6ee176a77a72740bd2cae286858e]['parent'] = $parent;
$this->functionData['commentsList'][$count_243b6ee176a77a72740bd2cae286858e]['preReply'] = $preReply;
}
...
<div class='comment_wrap' id='comment_wrap'>
	".$this->__f__a04e15e2dab2d10f2ff7233788592d07($comments,$settings,$pages,$parent,$preReply)."</div>
" . (($parent['_canComment']) ? ("
...
function __f__a04e15e2dab2d10f2ff7233788592d07($comments, $settings, $pages, $parent, $preReply='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_992f6e798dc7732d1b4a93c05b1e1639 = is_array($this->functionData['form']) ? count($this->functionData['form']) : 0;
$this->functionData['form'][$count_992f6e798dc7732d1b4a93c05b1e1639]['comment'] = $comment;
$this->functionData['form'][$count_992f6e798dc7732d1b4a93c05b1e1639]['parent'] = $parent;
$this->functionData['form'][$count_992f6e798dc7732d1b4a93c05b1e1639]['editor'] = $editor;
$this->functionData['form'][$count_992f6e798dc7732d1b4a93c05b1e1639]['settings'] = $settings;
$this->functionData['form'][$count_992f6e798dc7732d1b4a93c05b1e1639]['errors'] = $errors;
$this->functionData['form'][$count_992f6e798dc7732d1b4a93c05b1e1639]['do'] = $do;
}
$IPBHTML .= "" . (($errors) ? ("
