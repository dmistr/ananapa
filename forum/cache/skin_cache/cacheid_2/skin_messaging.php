...
{
$count_67ce948c0069885b9c44930ae103cc02 = is_array($this->functionData['messengerDisabled']) ? count($this->functionData['messengerDisabled']) : 0;
}
...
{
$count_f6cdc9a88acc0e795532332338ac4723 = is_array($this->functionData['messengerTemplate']) ? count($this->functionData['messengerTemplate']) : 0;
$this->functionData['messengerTemplate'][$count_f6cdc9a88acc0e795532332338ac4723]['html'] = $html;
$this->functionData['messengerTemplate'][$count_f6cdc9a88acc0e795532332338ac4723]['jumpmenu'] = $jumpmenu;
$this->functionData['messengerTemplate'][$count_f6cdc9a88acc0e795532332338ac4723]['dirData'] = $dirData;
$this->functionData['messengerTemplate'][$count_f6cdc9a88acc0e795532332338ac4723]['totalData'] = $totalData;
$this->functionData['messengerTemplate'][$count_f6cdc9a88acc0e795532332338ac4723]['topicParticipants'] = $topicParticipants;
$this->functionData['messengerTemplate'][$count_f6cdc9a88acc0e795532332338ac4723]['inlineError'] = $inlineError;
$this->functionData['messengerTemplate'][$count_f6cdc9a88acc0e795532332338ac4723]['deletedTopic'] = $deletedTopic;
}
$IPBHTML .= "<div class='master_list'>
	...
	" . ((is_array( $topicParticipants ) and count( $topicParticipants )) ? ("
		...
		".$this->__f__415b6f2aa2de85b1a3a645b452d599d9($html,$jumpmenu,$dirData,$totalData,$topicParticipants,$inlineError,$deletedTopic)."	") : ("")) . "				
	...
	" . (($this->settings['_hideFolders'] != 1) ? ("<h3>{$this->lang->words['folders']} " . (($this->memberData['g_max_messages'] > 0) ? ("<span class='subtext'>{$totalData['full_percent']}% {$this->lang->words['full']}</span>") : ("")) . "</h3>
		...
		" . ((count($dirData)) ? ("
			".$this->__f__0a5495d76c06e31b61b37b2040acf9d5($html,$jumpmenu,$dirData,$totalData,$topicParticipants,$inlineError,$deletedTopic)."		") : ("")) . "") : ("")) . "
</div>";
return $IPBHTML;
}


function __f__415b6f2aa2de85b1a3a645b452d599d9($html, $jumpmenu, $dirData, $totalData=array(), $topicParticipants=array(), $inlineError='', $deletedTopic=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__0a5495d76c06e31b61b37b2040acf9d5($html, $jumpmenu, $dirData, $totalData=array(), $topicParticipants=array(), $inlineError='', $deletedTopic=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_f9262c15f705a9624983594cf78cc138 = is_array($this->functionData['sendNewPersonalTopicForm']) ? count($this->functionData['sendNewPersonalTopicForm']) : 0;
$this->functionData['sendNewPersonalTopicForm'][$count_f9262c15f705a9624983594cf78cc138]['displayData'] = $displayData;
}
...
{
$count_76cef198d50e39da955f88a533d4c452 = is_array($this->functionData['sendReplyForm']) ? count($this->functionData['sendReplyForm']) : 0;
$this->functionData['sendReplyForm'][$count_76cef198d50e39da955f88a533d4c452]['displayData'] = $displayData;
}
$IPBHTML .= "" . (($this->settings['_hideFolders'] = 1) ? ("") : ("")) . "
...
{
$count_ff3895c849892ca21d8c654b6efa8a3d = is_array($this->functionData['showConversation']) ? count($this->functionData['showConversation']) : 0;
$this->functionData['showConversation'][$count_ff3895c849892ca21d8c654b6efa8a3d]['topic'] = $topic;
$this->functionData['showConversation'][$count_ff3895c849892ca21d8c654b6efa8a3d]['replies'] = $replies;
$this->functionData['showConversation'][$count_ff3895c849892ca21d8c654b6efa8a3d]['members'] = $members;
$this->functionData['showConversation'][$count_ff3895c849892ca21d8c654b6efa8a3d]['jump'] = $jump;
}
$IPBHTML .= "<div class='controls'>
	...
	{$topic['_pages']}
</div>".$this->__f__42331a37cc520108d2c5b47c127e0f57($topic,$replies,$members,$jump)."<div class='controls'>
	<div class='buttons'>
...
function __f__42331a37cc520108d2c5b47c127e0f57($topic, $replies, $members, $jump="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_0b095bcc50e3168a0ef5b958a5069a2c = is_array($this->functionData['showConversationForArchive']) ? count($this->functionData['showConversationForArchive']) : 0;
$this->functionData['showConversationForArchive'][$count_0b095bcc50e3168a0ef5b958a5069a2c]['topic'] = $topic;
$this->functionData['showConversationForArchive'][$count_0b095bcc50e3168a0ef5b958a5069a2c]['replies'] = $replies;
$this->functionData['showConversationForArchive'][$count_0b095bcc50e3168a0ef5b958a5069a2c]['members'] = $members;
}
...
$IPBHTML .= "<html>
	...
	<body>
		...
		<br />
		<br />
		".$this->__f__9faf47b830287945093e152490892f34($topic,$replies,$members)."	</body>
</html>";
return $IPBHTML;
}


function __f__9faf47b830287945093e152490892f34($topic, $replies, $members)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $replies as $msg_id => $msg )
...
{
$count_b051532573e22721581d55dc6023a340 = is_array($this->functionData['showFolder']) ? count($this->functionData['showFolder']) : 0;
$this->functionData['showFolder'][$count_b051532573e22721581d55dc6023a340]['messages'] = $messages;
$this->functionData['showFolder'][$count_b051532573e22721581d55dc6023a340]['dirname'] = $dirname;
$this->functionData['showFolder'][$count_b051532573e22721581d55dc6023a340]['pages'] = $pages;
$this->functionData['showFolder'][$count_b051532573e22721581d55dc6023a340]['currentFolderID'] = $currentFolderID;
$this->functionData['showFolder'][$count_b051532573e22721581d55dc6023a340]['jumpFolderHTML'] = $jumpFolderHTML;
}
...
" . ((count( $messages )) ? ("
		".$this->__f__4780f3bc535d55e96ccf5ba508220fef($messages,$dirname,$pages,$currentFolderID,$jumpFolderHTML)."") : ("
...
function __f__4780f3bc535d55e96ccf5ba508220fef($messages, $dirname, $pages, $currentFolderID, $jumpFolderHTML)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_25158c8646f29f9bf4515bd57bbac171 = is_array($this->functionData['showSearchResults']) ? count($this->functionData['showSearchResults']) : 0;
$this->functionData['showSearchResults'][$count_25158c8646f29f9bf4515bd57bbac171]['messages'] = $messages;
$this->functionData['showSearchResults'][$count_25158c8646f29f9bf4515bd57bbac171]['pages'] = $pages;
$this->functionData['showSearchResults'][$count_25158c8646f29f9bf4515bd57bbac171]['error'] = $error;
}
...
<div id='message_list'>
		<table class='ipb_table' id='message_table'>
			...
			" . ((count( $messages )) ? ("
								".$this->__f__e1d23845e243370826aa5c5461dc48b9($messages,$pages,$error)."			") : ("
				<tr>
...
function __f__e1d23845e243370826aa5c5461dc48b9($messages, $pages, $error)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $messages as $id => $msg )
