...
{
$count_9a9d5adcc4b7d6a11f65011d6d485714 = is_array($this->functionData['ajaxSharePost']) ? count($this->functionData['ajaxSharePost']) : 0;
$this->functionData['ajaxSharePost'][$count_9a9d5adcc4b7d6a11f65011d6d485714]['topic'] = $topic;
$this->functionData['ajaxSharePost'][$count_9a9d5adcc4b7d6a11f65011d6d485714]['post'] = $post;
$this->functionData['ajaxSharePost'][$count_9a9d5adcc4b7d6a11f65011d6d485714]['url'] = $url;
$this->functionData['ajaxSharePost'][$count_9a9d5adcc4b7d6a11f65011d6d485714]['sharelinks'] = $sharelinks;
}
$IPBHTML .= "<!--no data in this master skin-->";
return $IPBHTML;
}
...
{
$count_ed7ccd0e2284b547462a101e06a71dad = is_array($this->functionData['announcement_show']) ? count($this->functionData['announcement_show']) : 0;
$this->functionData['announcement_show'][$count_ed7ccd0e2284b547462a101e06a71dad]['announce'] = $announce;
$this->functionData['announcement_show'][$count_ed7ccd0e2284b547462a101e06a71dad]['author'] = $author;
}
...
{
$count_edf4ba312c700d69dcdbc532f83aa81e = is_array($this->functionData['archiveStatusMessage']) ? count($this->functionData['archiveStatusMessage']) : 0;
$this->functionData['archiveStatusMessage'][$count_edf4ba312c700d69dcdbc532f83aa81e]['topic'] = $topic;
$this->functionData['archiveStatusMessage'][$count_edf4ba312c700d69dcdbc532f83aa81e]['forum'] = $forum;
}
...
{
$count_27683504ccd3b8f21a3edf2658ebe1bc = is_array($this->functionData['hookFacebookLike']) ? count($this->functionData['hookFacebookLike']) : 0;
}
$IPBHTML .= "<!--no data in this master skin-->";
return $IPBHTML;
}
...
{
$count_3357f539f6e89492eb71a2f7ac42f623 = is_array($this->functionData['likeSummaryContents']) ? count($this->functionData['likeSummaryContents']) : 0;
$this->functionData['likeSummaryContents'][$count_3357f539f6e89492eb71a2f7ac42f623]['data'] = $data;
$this->functionData['likeSummaryContents'][$count_3357f539f6e89492eb71a2f7ac42f623]['relId'] = $relId;
$this->functionData['likeSummaryContents'][$count_3357f539f6e89492eb71a2f7ac42f623]['opts'] = $opts;
}
$IPBHTML .= "<!--no data in this master skin-->";
return $IPBHTML;
}
...
{
$count_2c2d60216d8ec68dcb70abced6b4e96d = is_array($this->functionData['pollDisplay']) ? count($this->functionData['pollDisplay']) : 0;
$this->functionData['pollDisplay'][$count_2c2d60216d8ec68dcb70abced6b4e96d]['poll'] = $poll;
$this->functionData['pollDisplay'][$count_2c2d60216d8ec68dcb70abced6b4e96d]['topicData'] = $topicData;
$this->functionData['pollDisplay'][$count_2c2d60216d8ec68dcb70abced6b4e96d]['forumData'] = $forumData;
$this->functionData['pollDisplay'][$count_2c2d60216d8ec68dcb70abced6b4e96d]['pollData'] = $pollData;
$this->functionData['pollDisplay'][$count_2c2d60216d8ec68dcb70abced6b4e96d]['showResults'] = $showResults;
$this->functionData['pollDisplay'][$count_2c2d60216d8ec68dcb70abced6b4e96d]['editPoll'] = $editPoll;
}
$IPBHTML .= "<div class='general_box alt poll' id='poll_{$poll['pid']}'>
	<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=forums&amp;module=extras&amp;section=vote&amp;t={$topicData['tid']}&amp;page={$this->request['page']}&amp;do=add&amp;secure_key={$this->member->form_hash}", "public",'' ), "", "" ) . "\" name='pollForm' method=\"post\">
		...
		") : ("")) . "
		".$this->__f__8e3c274093965b2c471ccbb38ceb6b42($poll,$topicData,$forumData,$pollData,$showResults,$editPoll)."		<fieldset class='submit'>
...
function __f__35a28afebbf15e1a01323db7f8a99b44($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1,$questionID='',$questionData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__8e3c274093965b2c471ccbb38ceb6b42($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $pollData as $questionID => $questionData )
	{
		...
		$_ips___x_retval .= "
			<div class='" . (($showResults) ? (" voted") : ("")) . "'>
				...
				") : ("
					<ol>
						".$this->__f__35a28afebbf15e1a01323db7f8a99b44($poll,$topicData,$forumData,$pollData,$showResults,$editPoll,$questionID,$questionData)."					</ol>
				")) . "
			</div>
...
{
$count_91fa59087b8e97185e9d2d716887d408 = is_array($this->functionData['post']) ? count($this->functionData['post']) : 0;
$this->functionData['post'][$count_91fa59087b8e97185e9d2d716887d408]['post'] = $post;
$this->functionData['post'][$count_91fa59087b8e97185e9d2d716887d408]['displayData'] = $displayData;
$this->functionData['post'][$count_91fa59087b8e97185e9d2d716887d408]['topic'] = $topic;
$this->functionData['post'][$count_91fa59087b8e97185e9d2d716887d408]['forum'] = $forum;
}
...
{
$count_4a96a44b82884c6aae9ab00d2c7c8228 = is_array($this->functionData['quickEditPost']) ? count($this->functionData['quickEditPost']) : 0;
$this->functionData['quickEditPost'][$count_4a96a44b82884c6aae9ab00d2c7c8228]['post'] = $post;
}
$IPBHTML .= "{$post['post']}
    {$post['attachmentHtml']}
	<br />
...
{
$count_ead3cb813bec400da554f7c74a16e774 = is_array($this->functionData['show_attachment_title']) ? count($this->functionData['show_attachment_title']) : 0;
$this->functionData['show_attachment_title'][$count_ead3cb813bec400da554f7c74a16e774]['title'] = $title;
$this->functionData['show_attachment_title'][$count_ead3cb813bec400da554f7c74a16e774]['data'] = $data;
$this->functionData['show_attachment_title'][$count_ead3cb813bec400da554f7c74a16e774]['type'] = $type;
}
$IPBHTML .= "<div id='attach_wrap' class='clearfix'>
	<h4>{$title}</h4>
	<ul>
		".$this->__f__2ae270621f8d44e6c18a0aa08f4c0389($title,$data,$type)."	</ul>
</div>";
return $IPBHTML;
}


function __f__2ae270621f8d44e6c18a0aa08f4c0389($title="",$data="",$type="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_4715d4ade24f4d993fda3ff24313b652 = is_array($this->functionData['Show_attachments']) ? count($this->functionData['Show_attachments']) : 0;
$this->functionData['Show_attachments'][$count_4715d4ade24f4d993fda3ff24313b652]['data'] = $data;
}
...
{
$count_ae171e4697e8e139ad107b54994a228e = is_array($this->functionData['softDeletedPostBit']) ? count($this->functionData['softDeletedPostBit']) : 0;
$this->functionData['softDeletedPostBit'][$count_ae171e4697e8e139ad107b54994a228e]['post'] = $post;
$this->functionData['softDeletedPostBit'][$count_ae171e4697e8e139ad107b54994a228e]['sdData'] = $sdData;
$this->functionData['softDeletedPostBit'][$count_ae171e4697e8e139ad107b54994a228e]['topic'] = $topic;
}
...
{
$count_fc84f7d40a627a3f98619dc7815f8306 = is_array($this->functionData['topicViewTemplate']) ? count($this->functionData['topicViewTemplate']) : 0;
$this->functionData['topicViewTemplate'][$count_fc84f7d40a627a3f98619dc7815f8306]['forum'] = $forum;
$this->functionData['topicViewTemplate'][$count_fc84f7d40a627a3f98619dc7815f8306]['topic'] = $topic;
$this->functionData['topicViewTemplate'][$count_fc84f7d40a627a3f98619dc7815f8306]['post_data'] = $post_data;
$this->functionData['topicViewTemplate'][$count_fc84f7d40a627a3f98619dc7815f8306]['displayData'] = $displayData;
}
...
<div class='master_list'>
	...
	" . ((is_array( $post_data ) AND count( $post_data )) ? ("
		".$this->__f__744651247fdb880feffe835c00090653($forum,$topic,$post_data,$displayData)."	") : ("")) . "
	...
	") : ("")) . "
		...
		<div style='text-align:center'>
			...
			<div id='mobileModOptions' style='display:none'>
				".$this->__f__8f23fd7153fbb68e7c070847ce3338c8($forum,$topic,$post_data,$displayData)."			</div>
		</div>
	") : ("")) . "
	<div class='controls'>
		<div class='buttons'>
...
function __f__744651247fdb880feffe835c00090653($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__8f23fd7153fbb68e7c070847ce3338c8($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
