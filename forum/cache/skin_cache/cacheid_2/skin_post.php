...
{
$count_d967a7b66e8f8b0fcdd5edcb0123ffba = is_array($this->functionData['pollBox']) ? count($this->functionData['pollBox']) : 0;
$this->functionData['pollBox'][$count_d967a7b66e8f8b0fcdd5edcb0123ffba]['data'] = $data;
}
...
{
$count_8170b41f28e6e5cb7bf8c1997623a5fc = is_array($this->functionData['postFormTemplate']) ? count($this->functionData['postFormTemplate']) : 0;
$this->functionData['postFormTemplate'][$count_8170b41f28e6e5cb7bf8c1997623a5fc]['formData'] = $formData;
$this->functionData['postFormTemplate'][$count_8170b41f28e6e5cb7bf8c1997623a5fc]['form'] = $form;
}
...
{
$count_5d22946a73935ffd28e089087a655dbb = is_array($this->functionData['preview']) ? count($this->functionData['preview']) : 0;
$this->functionData['preview'][$count_5d22946a73935ffd28e089087a655dbb]['data'] = $data;
}
...
{
$count_887bdaa4e11464248dc7b432aa18b353 = is_array($this->functionData['topicSummary']) ? count($this->functionData['topicSummary']) : 0;
$this->functionData['topicSummary'][$count_887bdaa4e11464248dc7b432aa18b353]['posts'] = $posts;
}
...
" . ((is_array( $posts ) AND count( $posts )) ? ("
	".$this->__f__36f0843267e3ddb8645ac0ea522ffcb4($posts)."") : ("")) . "
<p class='submit'>
...
function __f__36f0843267e3ddb8645ac0ea522ffcb4($posts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_4cc7131a6fd9e4295f7ee5e465cdb9e3 = is_array($this->functionData['uploadForm']) ? count($this->functionData['uploadForm']) : 0;
$this->functionData['uploadForm'][$count_4cc7131a6fd9e4295f7ee5e465cdb9e3]['post_key'] = $post_key;
$this->functionData['uploadForm'][$count_4cc7131a6fd9e4295f7ee5e465cdb9e3]['type'] = $type;
$this->functionData['uploadForm'][$count_4cc7131a6fd9e4295f7ee5e465cdb9e3]['stats'] = $stats;
$this->functionData['uploadForm'][$count_4cc7131a6fd9e4295f7ee5e465cdb9e3]['id'] = $id;
$this->functionData['uploadForm'][$count_4cc7131a6fd9e4295f7ee5e465cdb9e3]['forum_id'] = $forum_id;
}
