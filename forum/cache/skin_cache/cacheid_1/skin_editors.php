...
{
$count_871a12e49c4f406819c68ef2e45b2b7b = is_array($this->functionData['ajaxEditBox']) ? count($this->functionData['ajaxEditBox']) : 0;
$this->functionData['ajaxEditBox'][$count_871a12e49c4f406819c68ef2e45b2b7b]['post'] = $post;
$this->functionData['ajaxEditBox'][$count_871a12e49c4f406819c68ef2e45b2b7b]['pid'] = $pid;
$this->functionData['ajaxEditBox'][$count_871a12e49c4f406819c68ef2e45b2b7b]['error_msg'] = $error_msg;
$this->functionData['ajaxEditBox'][$count_871a12e49c4f406819c68ef2e45b2b7b]['extraData'] = $extraData;
}
...
{
$count_7a2b2d8f7b26c1d32199e2175611e9ba = is_array($this->functionData['editor']) ? count($this->functionData['editor']) : 0;
$this->functionData['editor'][$count_7a2b2d8f7b26c1d32199e2175611e9ba]['formField'] = $formField;
$this->functionData['editor'][$count_7a2b2d8f7b26c1d32199e2175611e9ba]['content'] = $content;
$this->functionData['editor'][$count_7a2b2d8f7b26c1d32199e2175611e9ba]['options'] = $options;
$this->functionData['editor'][$count_7a2b2d8f7b26c1d32199e2175611e9ba]['autoSaveData'] = $autoSaveData;
$this->functionData['editor'][$count_7a2b2d8f7b26c1d32199e2175611e9ba]['warningInfo'] = $warningInfo;
$this->functionData['editor'][$count_7a2b2d8f7b26c1d32199e2175611e9ba]['acknowledge'] = $acknowledge;
$this->functionData['editor'][$count_7a2b2d8f7b26c1d32199e2175611e9ba]['bbcodeVersion'] = $bbcodeVersion;
$this->functionData['editor'][$count_7a2b2d8f7b26c1d32199e2175611e9ba]['showEditor'] = $showEditor;
}
...
{
$count_8de09ed9dcab7f408023e52741432916 = is_array($this->functionData['editorLoadJs']) ? count($this->functionData['editorLoadJs']) : 0;
$this->functionData['editorLoadJs'][$count_8de09ed9dcab7f408023e52741432916]['options'] = $options;
$this->functionData['editorLoadJs'][$count_8de09ed9dcab7f408023e52741432916]['inlineLoad'] = $inlineLoad;
}
...
{
$count_dfd6c7f690f79b15eeae2934bcee99b1 = is_array($this->functionData['mediaGenericWrapper']) ? count($this->functionData['mediaGenericWrapper']) : 0;
$this->functionData['mediaGenericWrapper'][$count_dfd6c7f690f79b15eeae2934bcee99b1]['rows'] = $rows;
$this->functionData['mediaGenericWrapper'][$count_dfd6c7f690f79b15eeae2934bcee99b1]['pages'] = $pages;
$this->functionData['mediaGenericWrapper'][$count_dfd6c7f690f79b15eeae2934bcee99b1]['app'] = $app;
$this->functionData['mediaGenericWrapper'][$count_dfd6c7f690f79b15eeae2934bcee99b1]['plugin'] = $plugin;
}
...
<div>
	<ul class='media_results'>
		" . ((count($rows)) ? ("
			".$this->__f__0703d5fc71ee5defdee332f76d3bf295($rows,$pages,$app,$plugin)."		") : ("
...
function __f__0703d5fc71ee5defdee332f76d3bf295($rows, $pages, $app, $plugin)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $row )
...
{
$count_0060877f8637f25b0d526759f50a4c27 = is_array($this->functionData['sharedMedia']) ? count($this->functionData['sharedMedia']) : 0;
$this->functionData['sharedMedia'][$count_0060877f8637f25b0d526759f50a4c27]['tabs'] = $tabs;
}
...
<div class='fixed_inner ipsBox'>
	...
	<div class='ipsVerticalTabbed ipsLayout ipsLayout_withleft ipsLayout_smallleft clearfix'>
		<div class='ipsVerticalTabbed_tabs ipsLayout_left'>
			<ul id='mymedia_tabs'>
				".$this->__f__a2c99c440576bfe96d786eec6614d75b($tabs)."			</ul>
		</div>
...
function __f__a2c99c440576bfe96d786eec6614d75b($tabs)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $tabs as $tab )
