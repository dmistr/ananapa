...
{
$count_43682708e1c51afca85ea56b67ab73ec = is_array($this->functionData['comment']) ? count($this->functionData['comment']) : 0;
$this->functionData['comment'][$count_43682708e1c51afca85ea56b67ab73ec]['r'] = $r;
$this->functionData['comment'][$count_43682708e1c51afca85ea56b67ab73ec]['parent'] = $parent;
$this->functionData['comment'][$count_43682708e1c51afca85ea56b67ab73ec]['settings'] = $settings;
}
...
{
$count_1e95a989857afbe903308419ef48c63c = is_array($this->functionData['commentHidden']) ? count($this->functionData['commentHidden']) : 0;
$this->functionData['commentHidden'][$count_1e95a989857afbe903308419ef48c63c]['r'] = $r;
$this->functionData['commentHidden'][$count_1e95a989857afbe903308419ef48c63c]['parent'] = $parent;
$this->functionData['commentHidden'][$count_1e95a989857afbe903308419ef48c63c]['settings'] = $settings;
}
...
{
$count_4e92a63ed5511a339ce691a3a7f66569 = is_array($this->functionData['commentsList']) ? count($this->functionData['commentsList']) : 0;
$this->functionData['commentsList'][$count_4e92a63ed5511a339ce691a3a7f66569]['comments'] = $comments;
$this->functionData['commentsList'][$count_4e92a63ed5511a339ce691a3a7f66569]['settings'] = $settings;
$this->functionData['commentsList'][$count_4e92a63ed5511a339ce691a3a7f66569]['pages'] = $pages;
$this->functionData['commentsList'][$count_4e92a63ed5511a339ce691a3a7f66569]['parent'] = $parent;
$this->functionData['commentsList'][$count_4e92a63ed5511a339ce691a3a7f66569]['preReply'] = $preReply;
}
...
<div class='ipsComment_wrap' id='comment_wrap'>
	".$this->__f__6532b835f742b8601a57f8fe73f529f9($comments,$settings,$pages,$parent,$preReply)."</div>
" . (($pages) ? ("
	<div class='topic_controls'>
		{$pages}
	</div>
...
function __f__6532b835f742b8601a57f8fe73f529f9($comments, $settings, $pages, $parent, $preReply='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_aa0fe7159d364266c5c1414ed222377a = is_array($this->functionData['form']) ? count($this->functionData['form']) : 0;
$this->functionData['form'][$count_aa0fe7159d364266c5c1414ed222377a]['comment'] = $comment;
$this->functionData['form'][$count_aa0fe7159d364266c5c1414ed222377a]['parent'] = $parent;
$this->functionData['form'][$count_aa0fe7159d364266c5c1414ed222377a]['editor'] = $editor;
$this->functionData['form'][$count_aa0fe7159d364266c5c1414ed222377a]['settings'] = $settings;
$this->functionData['form'][$count_aa0fe7159d364266c5c1414ed222377a]['errors'] = $errors;
$this->functionData['form'][$count_aa0fe7159d364266c5c1414ed222377a]['do'] = $do;
}
$IPBHTML .= "" . (($errors) ? ("
